...
if (!isNull _unit) then {
	...
	_unit addHeadgear 'US_2001_MarpatDesert_PASGTHelmet1';

	_unit addVest 'US_2001_MarpatDesert_PlateCarrier';
	_unit addUniform 'US_2001_MarpatDesert_FieldUniform2';
	_unit addBackPack 'US_2001_MarpatDesert_Carryall';

...
onLoadMission			= "Load Mission Text!!";	// Displays a message while the mission is loading.
onLoadIntro				= "Load Intro Text!!";	// Displays a message while the intro is loading.

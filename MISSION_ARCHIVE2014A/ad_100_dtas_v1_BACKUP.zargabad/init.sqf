...
// If preinit.sqf script was bugged and did not run, prompt and prevent playing until player quits and rejoins.
if (isNil "preInitDone") then
{
	[] spawn
	{
		while {true} do
		{
			hintC localize "STR_PreInitBugged";
			sleep 3;
		};
	};
};

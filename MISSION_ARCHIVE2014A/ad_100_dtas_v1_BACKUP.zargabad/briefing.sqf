...
player createDiaryRecord ["Diary", [localize "STR_Credits", format ["%1<br/><br/>%2<br/><br/>%3<br/><br/><img image='dtaslogo.jpg' width='350' height='175'/>", localize "STR_Credits1", localize "STR_Credits2", localize "STR_Credits3"]]];

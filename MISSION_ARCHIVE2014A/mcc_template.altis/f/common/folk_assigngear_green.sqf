...
// Backpacks
_bagmedium = "B_TacticalPack_oli";  			// used by most roles		
...
_lightUniform = "U_I_CombatUniform_shortsleeve";
_baseHelmet = "H_HelmetIA_net";
_lightHelmet = "H_HelmetIA_camo";
_lightRig = "V_PlateCarrierIA2_dgtl"; // co,dc,ftl,medic,rat,matag,mmgag
...
_pilotHelmet = "H_CrewHelmetHeli_I";

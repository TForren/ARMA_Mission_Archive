...
hint "Please wait while the zones are being generated...";
...
//        endLoadingScreen;
    ...
    if (_playerDistance>(zones_max_radius + 500))  then {  // VERIFIE SI ELOIGNE DU JOUEUR ET REGARDE LA DISTANCE DES AUTRES ZONES  
...
//           hint format["%1",_distance];
     ...
     _null = [format["Zone %1",_i],_points_zone,_zone_radius,_MissionPos,_fortified,true] execvm "initZones\createzone.sqf";     
     _found=true;
...
hint format["Campaign generated\nzones: %1\nmaximum radius: %2\nminimum radius: %3\n\nIf you experience performance issues, restart the mission and try reducing the amount of zones/and or their radius",zones_number,zones_max_radius,zones_min_radius];

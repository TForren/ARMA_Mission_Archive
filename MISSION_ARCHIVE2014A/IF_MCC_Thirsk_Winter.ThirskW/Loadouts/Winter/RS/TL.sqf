...
if (!isNull _unit) then {
	...
	_unit addHeadgear 'US_2001_MarpatWinter_PASGTHelmet1';

	_unit addVest 'US_2001_MarpatWinter_PlateCarrier';
	_unit addUniform 'US_2001_MarpatWinter_FieldUniform2';
	_unit addBackPack 'US_2001_MarpatWinter_Carryall';

	BRS_RP_fnc = compile preprocessFile "common\client\BRS\functions\respawn_points.sqf";
	findSpawn_fnc = compile preprocessFile "common\client\BRS\functions\set_spawn.sqf";
	squadRespawn_fnc = compile preprocessFile "common\client\BRS\functions\respawn_player.sqf";
	getSpawnText_fnc = compile preprocessFile "common\client\BRS\functions\BRS_text_fnc.sqf";
	BRS_keyspressed = compile preprocessFile "common\client\BRS\functions\spawn_keys.sqf";
...
// ADDACTION			
	if (_addAction) 
		...
		player SETVARIABLE ["AAlimitEnemy",_limitEnemy];
			null= [false,true] execVM "common\client\BRS\BRS_init.sqf";

    ...
    class Controls
    {
      ...
      class BRS_button_OpenMap: BRS_subButton
        {
		 ...
		 action = "ctrlShow [31052,true]; ctrlShow [31051,false];_nil=[]spawn {if (BRS_mapClose) then {null = [false] execVM ""common\client\BRS\BRS_map\map_close.sqf"";}else{null = [true] execVM ""common\client\BRS\BRS_map\map_close.sqf"";};}";
        };
      class BRS_button_CloseMap: BRS_subButton
		...
		colorBackgroundActive[] =  {0.259,0.706,0.929,1};
		 colorText[] = {0,0,0,1};
		 action = "ctrlShow [31051,true]; ctrlShow [31052,false];_nil=[]spawn {if (BRS_mapClose) then {null = [false] execVM ""common\client\BRS\BRS_map\map_close.sqf"";}else{null = [true] execVM ""common\client\BRS\BRS_map\map_close.sqf"";};}";
        };		

...
// EAST CSAT FACTION
	...
	_CHPool=	["O_Heli_Light_02_F","O_Heli_Attack_02_black_F","O_Heli_Attack_02_F"];
...
// MIDDLE EAST CIVILIAN AGGRESSORS 	
	if (_faction==6) then {
	_InfPool=	["CAF_AG_ME_CIV","CAF_AG_ME_CIV_02","CAF_AG_ME_CIV_03","CAF_AG_ME_CIV_04"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];

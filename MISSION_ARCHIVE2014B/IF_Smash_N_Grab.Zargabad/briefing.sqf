...
Mission ends when hemp truck is liberated and brought to transfer team.<br />
<br />
ENDTAB;
...
NEWTAB("II. Mission:")
Liberate hemp shipment<br />
ENDTAB;

NEWTAB("B. Friendly Forces:")
FIA transfer team awaiting shipment<br />
Band of FIA raiders <br />

ENDTAB;

NEWTAB("A. Enemy Forces:")
Platoon size of African mercenary security forces. 
ENDTAB;

NEWTAB("I. Situation:")
This guy living in the villa has been making quite a sum of money off his hemp farm. A bit too much. We're going to liberate his next shipment right under his nose. 
There's a mess of mercs in the villa so try to stay clear of that. Get in, get the truck, get out. ENDTAB;
};

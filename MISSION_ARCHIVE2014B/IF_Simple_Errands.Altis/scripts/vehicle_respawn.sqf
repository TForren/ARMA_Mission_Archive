// 0 = [this, delay, deserted timer] execVM "scripts\vehicle_respawn.sqf";
...
=========================================================
  ...
  0 = [this] execVM "scripts\vehicle_respawn.sqf"


  Options:
  There are some optional settings. The format for these are:
  0 = [this, Delay, Deserted timer, Respawns, Effect, Static] execVM "scripts\vehicle_respawn.sqf"

  
  Default respawn delay is 30 seconds, to set a custom
  respawn delay time, put that in the init as well. 
  Like this:
  0 = [this, 15] execVM "scripts\vehicle_respawn.sqf"
  ...
  Like this:  
  0 = [this, 15, 10] execVM "scripts\vehicle_respawn.sqf"
  ...
  Like this:
  0 = [this, 15, 10, 5] execVM "scripts\vehicle_respawn.sqf"


  Set this value to TRUE to add a special explosion effect to the wreck when respawning.
  Default value is FALSE, which will simply have the wreck disappear.
  Like this:
  0 = [this, 15, 10, 5, TRUE] execVM "scripts\vehicle_respawn.sqf"
  ...
  Like this:
  0 = [this, 15, 10, 5, TRUE, TRUE] execVM "scripts\vehicle_respawn.sqf"
  ...
  Like this:
  0 = [this, 15, 10, 5, TRUE, FALSE, "this setDammage 0.5"] execVM "scripts\vehicle_respawn.sqf"
  
  Default values of all settings are:
  0 = [this, 30, 120, 0, FALSE, FALSE] execVM "scripts\vehicle_respawn.sqf"

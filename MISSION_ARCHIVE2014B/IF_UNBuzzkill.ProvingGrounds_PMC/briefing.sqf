...
Mission ends when Black Market has been dismantled.<br />
<br />
ENDTAB;
...
NEWTAB("II. Mission:")
Dismantle black market operations<br />
ENDTAB;

NEWTAB("B. Friendly Forces:")
Platoon of UN security Forces.<br />
Band of FIA raiders <br />

ENDTAB;

NEWTAB("A. Enemy Forces:")
Band of black market dealers and security contractors. 
ENDTAB;

NEWTAB("I. Situation:")
There's been a surge in contraband trade recently in the area. Fortunately, it's gotten a bit too big and their location has been found. UN forces will move in and dismantle the black market operations. ENDTAB;
};

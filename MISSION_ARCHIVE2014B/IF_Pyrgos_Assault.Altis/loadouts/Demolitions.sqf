...
_this addMagazine "SmokeShell";
_this addMagazines["DemoCharge_Remote_Mag",2];
(unitBackpack _this) addMagazineCargo["ATMine_Range_Mag", 1];
(unitBackpack _this) addMagazineCargo["APERSTripMine_Wire_Mag", 2];

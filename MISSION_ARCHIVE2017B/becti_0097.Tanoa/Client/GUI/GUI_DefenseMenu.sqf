...
while { true } do {
	if (isNil {uiNamespace getVariable "cti_dialog_ui_defensemenu"}) exitWith { if (CTI_VAR_DestroyCam) then {camDestroy CTI_ConstructionCamera; CTI_ConstructionCamera = nil;} }; //--- Menu is closed.

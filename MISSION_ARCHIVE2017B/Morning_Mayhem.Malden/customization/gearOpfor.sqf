...
// Primary
#define O_rifle_r "rhs_weap_ak74m","rhs_weap_ak74m_2mag","rhs_weap_ak74m_plummag","rhs_weap_ak74m_fullplum"
#define O_rifle "rhs_weap_ak74m"
#define O_rifle2 "rhs_weap_ak74m_fullplum"
#define O_glrifle_r "rhs_weap_ak74m_gp25","rhs_weap_ak74m_fullplum_gp25"
#define O_glrifle "rhs_weap_ak74m_gp25"
#define O_glrifle2 "rhs_weap_ak74m_fullplum_gp25"
...
//Uniform              
#define O_default_uniform "rhs_uniform_vdv_emr"
...
#define O_vest_ftl "rhs_6b23_digi_6sh92_vog_headset"
...
#define O_vest_leader "rhs_6b23_digi_6sh92_headset"
#define O_vest_officer "rhs_6b23_digi_crewofficer"
#define O_vest_psgt "rhs_6b23_digi_6sh92_headset_mapcase"
...
case "O_PC": {
		...
		//Attachments
		[ [O_red_dot2], [O_rifle_scope2], [O_red_dot2] ] call fnc_AddItemRandom;
...
case "O_SGT": {
		...
		//Attachments
		[ [O_red_dot2], [O_red_dot2] ] call fnc_AddItemRandom;
		[O_akmb] call FNC_AddItem;
		[O_fl] call FNC_AddItem;
...
case "O_GRE": {
		...
		[O_riflemag_tr,2,"vest"] call FNC_AddItem;
		[O_glbouncehe,12,"vest"] call FNC_AddItem;
...
case "O_MGA": {
		...
		//Vest
		[O_riflemag,8,"vest"] call FNC_AddItem;
		[O_riflemag_tr,2,"vest"] call FNC_AddItem;

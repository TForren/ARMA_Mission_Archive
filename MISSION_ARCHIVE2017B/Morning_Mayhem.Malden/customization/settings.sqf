if (isServer) then { //This scope is only for the server
	...
	[east, "VDV Spetsnaz", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[independent, "Hellantic Forces", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east
...
victoryMessage = "VDV have secured OBJ Kamen <br/><br/>VDV VICTORY<br/>";
failureMessage = "VDV forces have taken too many casualties to continue operations. <br/><br/>HELLANTIC VICTORY<br/>";

...
NEWTAB("I. Situation:")
<br/>
US Forces conduct a reconnaissance in force to test Russian MSV defensive strength on the island. US ABCT platoon will attack MSV positions and retreat should reinforcements grow too strong.
<br/>
<br/>
...
Early foggy morning. Scattered clouds.
<br/><br/>
ENDTAB;
...
Modern Russian Federation equipment. Body armor and heavy vehicles. Emplaced AT/AP weapons expected.
<br/>
<br/>
<font color='#FFA500'>Strength:<br/></font>
(Possible)<br/>
2x Mechanized Platoon<br/>
1x Heavy armor platoon<br/>
Possible close air support<br/>
...
Russian MSV may likely take up a defensive posture with limited manpower.
<br/>
<br/>
<font color='#FFA500'>MDCOA:<br/></font>
Russian MSV QRFs may react quicker than expected and overwhelm the US.
<br/>
<br/>
<font color='#FFA500'>Defensive Fires:<br/></font>
Possible mortar support.
<br/>
<br/>
...
STALLION PLT is staged north of Katkoula with OOM:<br/>
<br/>
1'1 Bravo - M2 HMMWV<br/>
1'1 Alpha - M2A3 Bradley<br/>
1'2 Bravo - M2 HMMWV<br/>
1'2 Alpha - M2A3 Bradley<br/>
1'6 PLT LDR - MK19 MRAP<br/>
1'7 PLT SGT - MK19 MRAP<br/>
...
Remove MSV presence from the island.
<br/><br/>
...
NEWTAB("II. Mission:")
RECON IN FORCE Russian MSV positions. extract if heavy casualties would be unavoidable.
ENDTAB;

NEWTAB("III. Execution:")

<font color='#FFA500'>a. Concept of the Operation</font><br/>
STALLION PLT will perform a recon in force on Russian MSV.
<br/>
<br/>
...
if (_adminState != 0 || _uid == "76561198013584551" || _uid == "76561197988578942") then {
	...
	<br/><execute expression='victoryMessage call FNC_EndMissionRequest'>Call Blufor Victory</execute>  
	<br/>
	<br/><execute expression='failureMessage call FNC_EndMissionRequest'>Call Opfor Victory</execute>
	ENDTAB;
};

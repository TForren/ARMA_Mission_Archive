...
if(vas_disableLoadSave) then {
	missionNamespace setVariable [ format["PO3_VAS_gearSlot_%1_%2_%3",side player, player getVariable ["PO3_VAR_roleAttribute","Rifleman"],_slot],[_title,_primary,_launcher,_handgun,_magazines,_uniform,_vest,_backpack,_items,_primitems,_secitems,_handgunitems,_uitems,_vitems,_bitems]];
}else{
	profileNameSpace setVariable [ format["PO3_VAS_gearSlot_%1_%2_%3",side player, player getVariable ["PO3_VAR_roleAttribute","Rifleman"],_slot],[_title,_primary,_launcher,_handgun,_magazines,_uniform,_vest,_backpack,_items,_primitems,_secitems,_handgunitems,_uitems,_vitems,_bitems]];

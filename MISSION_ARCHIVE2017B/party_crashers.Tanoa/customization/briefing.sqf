...
if (_adminState != 0 || _uid == "76561198013584551" || _uid == "76561197988578942") then {
	...
	<br/>
	<br/><execute expression='ExtractbothKilled call FNC_EndMissionRequest'>Extracted with both killed</execute>  
	<br/>
	<br/><execute expression='ExtractbothCaptured call FNC_EndMissionRequest'>Extracted both captured</execute>
	<br/>
	<br/><execute expression='ExtractoneKilledOneCaptured call FNC_EndMissionRequest'>Extracted one kill one capture</execute>
	<br/>
	<br/><execute expression='ExtractoneKilledOneFree call FNC_EndMissionRequest'>Extracted one kill one free</execute>
	<br/>
	<br/><execute expression='ExtractoneCapturedOneFree call FNC_EndMissionRequest'>Extracted one captured one free</execute>
	<br/>
	<br/>
	<br/><execute expression='ExtractfailureMessage call FNC_EndMissionRequest'>Extracted both free (failure)</execute>
	<br/>
	<br/><execute expression='failureMessage call FNC_EndMissionRequest'>Too many casualties (failure)</execute>

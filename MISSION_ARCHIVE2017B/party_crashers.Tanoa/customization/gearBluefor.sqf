...
#define B_pump "UK3CB_BAF_L128A1"
...
#define B_buck "UK3CB_BAF_12G_Pellets"
#define B_slug "UK3CB_BAF_12G_Slugs"
...
case "B_PC": {
	...
	[B_smoker,3,"vest"] call FNC_AddItem;
...
case "B_SL": {		
	...
	[B_glsmokered,4,"backpack"] call FNC_AddItem;
	[B_glsmokeblue,4,"backpack"] call FNC_AddItem;
...
case "B_JTAC": {
	...
	[B_glsmokeblue,2,"vest"] call FNC_AddItem;

	//Backpack

	[B_flare,4,"backpack"] call FNC_AddItem;
	[B_smokey,2,"backpack"] call FNC_AddItem;
	[B_smoker,2,"backpack"] call FNC_AddItem;
	[B_smokeb,2,"backpack"] call FNC_AddItem;
...
case "B_PIL": {
	...
	["rhs_scarf"] call FNC_AddItemRandom;

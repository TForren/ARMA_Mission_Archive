...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["rhs_vmf_flora_rifleman", 5], ["rhs_vmf_flora_machinegunner", 2], ["rhs_vmf_flora_medic", 1], ["rhs_vmf_flora_LAT", 1], ["rhs_vmf_flora_grenadier_rpg", 2], ["rhs_vmf_recon_marksman", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1725];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAT"];
_t = _t		+ ["Infantry - AT"];
_p = _p		+ [[["rhs_vmf_flora_LAT", 5], ["rhs_vmf_flora_medic", 1], ["rhs_vmf_flora_LAT", 3]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [4865];
_c = _c		+ ["InfantryAT"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAA"];
_t = _t		+ ["Infantry - AA"];
_p = _p		+ [[["rhs_vmf_flora_aa", 5], ["rhs_vmf_flora_medic", 1], ["rhs_vmf_flora_LAT", 2]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [2415];
_c = _c		+ ["InfantryAA"];
_s = _s		+ [[]];
...
_p = _p		+ [[["rhs_vmf_recon_marksman", 2], ["rhs_vmf_recon_marksman", 1], ["rhs_vmf_recon_marksman", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1300];
...
_p = _p		+ [[["rhs_tigr_vmf", 3], ["rhs_tigr_sts_vmf", 2]]];
_f = _f		+ [CTI_LIGHT];
_m = _m		+ [6500];
_c = _c		+ ["Motorized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["rhs_btr80_vmf", 1], ["rhs_btr80a_vmf", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6400];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];

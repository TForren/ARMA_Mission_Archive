...
missionNamespace setVariable [format["CTI_%1_HQ", _side], "RHS_M2A2_wd"];
...
_classes = _classes 		+ [["LAV25_HQ_unfolded", "Land_Cargo20_military_green_F"]];
...
_classes = _classes 		+ [["USMC_WarfareBFieldhHospital", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [60];
...
_classes = _classes 		+ [["USMC_WarfareBLightFactory", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [600];
_times = _times 			+ [80];
...
_classes = _classes 		+ [["USMC_WarfareBUAVterminal", "Land_Cargo20_military_green_F"]];
...
_classes = _classes 		+ [["USMC_WarfareBHeavyFactory", "Land_Cargo40_military_green_F"]];
...
_classes = _classes 		+ [["USMC_WarfareBAircraftFactory", "Land_Cargo40_military_green_F"]];
...
_classes = _classes 		+ [["USMC_WarfareBVehicleServicePoint", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [40];
_placements = _placements 	+ [[180, 20]];
_helper = _helper			+ [["Sign_Arrow_Large_Blue_F", 0]];
...
_classes = _classes 		+ ["B_Static_Designator_01_F"];
_prices = _prices 			+ [250];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["MG Defense"];
_classes = _classes 		+ ["RHS_M2StaticMG_MiniTripod_USMC_WD"];
_prices = _prices 			+ [400];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["MG Defense (Raised)"];
_classes = _classes 		+ ["RHS_M2StaticMG_USMC_WD"];
_prices = _prices 			+ [600];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["GL Defense"];
_classes = _classes 		+ ["RHS_MK19_TriPod_USMC_WD"];
_prices = _prices 			+ [700];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["AT Defense"];
_classes = _classes 		+ ["RHS_TOW_TriPod_USMC_WD"];
_prices = _prices 			+ [1800];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["AA Defense"];
_classes = _classes 		+ ["RHS_Stinger_AA_pod_USMC_WD"];

...
missionNamespace setVariable [format["CTI_%1_HQ", _side], "rhs_bmp2k_msv"];
...
_classes = _classes 		+ [["BTR90_HQ_unfolded", "Land_Cargo20_military_green_F"]];
...
_classes = _classes 		+ [["RU_WarfareBBarracks", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [60];
...
_classes = _classes 		+ [["RU_WarfareBLightFactory", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [600];
_times = _times 			+ [80];
...
_classes = _classes 		+ [["RU_WarfareBUAVterminal", "Land_Cargo20_military_green_F"]];
...
_classes = _classes 		+ [["RU_WarfareBHeavyFactory", "Land_Cargo40_military_green_F"]];
...
_classes = _classes 		+ [["RU_WarfareBAircraftFactory", "Land_Cargo40_military_green_F"]];
...
_classes = _classes 		+ [["RU_WarfareBVehicleServicePoint", "Land_Cargo20_military_green_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [40];
_placements = _placements 	+ [[180, 20]];
_helper = _helper			+ [["Sign_Arrow_Large_Blue_F", 0]];
...
_classes = _classes 		+ ["rhs_KORD_VMF"];
_prices = _prices 			+ [400];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["MG Defense (Raised)"];
_classes = _classes 		+ ["rhs_KORD_high_VMF"];
_prices = _prices 			+ [600];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["GL Defense"];
_classes = _classes 		+ ["RHS_AGS30_TriPod_VMF"];
_prices = _prices 			+ [700];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["AT Defense"];
_classes = _classes 		+ ["rhs_Kornet_9M133_2_vmf"];
_prices = _prices 			+ [1800];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["AA Defense"];
_classes = _classes 		+ ["rhs_Igla_AA_pod_vmf"];
_prices = _prices 			+ [1600];
_placements = _placements 	+ [[180, 15]];
_categories = _categories 	+ ["Defense"];

_headers = _headers 		+ ["Mortar"];
_classes = _classes 		+ ["rhs_2b14_82mm_vmf"];

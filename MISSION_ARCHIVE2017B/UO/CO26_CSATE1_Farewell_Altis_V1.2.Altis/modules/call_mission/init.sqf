...
// Admin Call Options
["AdminWin", sideUnknown, "Call Mission CSAT Extracted", [east, "Extract", true]] call FNC_RegisterMissionCall;
["AdminLoose", sideUnknown, "Call Mission CSAT Combat Inneffective", [east, "OPFOREliminated", false]] call FNC_RegisterMissionCall;
["Admin", sideUnknown, "Call Mission No Outcome", [east, "AdminCalled", false]] call FNC_RegisterMissionCall;

...
["SURRENDER", east, "Surrender", ["MissionCalled", false]] call FNC_RegisterMissionCall;
...
[east, ["Viper", "Viper Green", "Viper Red", "Viper Blue", "Scorpio", "Medio"]] call FNC_RegisterCOC;
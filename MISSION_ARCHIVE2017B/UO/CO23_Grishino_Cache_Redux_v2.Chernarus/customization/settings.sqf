...
if (isServer) then { //This scope is only for the server
	...
	[west, "2-13 Infantry Rgt", "player"] call FNC_AddTeam; //Adds a player team called USMC on side west
	[resistance, "Slovak Insurgents", "ai"] call FNC_AddTeam; //Adds a ai team called VDV on side east

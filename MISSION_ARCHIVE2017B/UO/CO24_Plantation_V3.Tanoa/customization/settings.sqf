...
if (isServer) then { //This scope is only for the server
	...
	[independent, "smug", "ai"] call FNC_AddTeam; //Adds a player team called USMC on side west
	[west, "blu", "player"] call FNC_AddTeam; //Adds a ai team called VDV on side east

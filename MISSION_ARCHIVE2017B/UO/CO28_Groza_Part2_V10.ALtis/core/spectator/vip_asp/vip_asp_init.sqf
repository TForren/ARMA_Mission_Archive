/*
	...
	Example:
		["Init", [false, true]] call compile preprocessfilelinenumbers "core\spectator\vip_asp\vip_asp_init.sqf";
		["Start", [true]] call compile preprocessfilelinenumbers "core\spectator\vip_asp\vip_asp_init.sqf";
...
if (isNull player) exitWith {_this spawn {waitUntil {!isNull player}; _this call compile preProcessFileLineNumbers "core\spectator\vip_asp\vip_asp_init.sqf"}};
...
switch (_mode) do {
	...
	case "Init": {
		...
		player addEventHandler ["Respawn", {
			...
			["Start"] call compile preprocessFileLineNumbers "core\spectator\vip_asp\vip_asp_init.sqf"
		}];
	...
	case "Start": {
		...
		if (isNil "vip_asp_var_cl_respawnDelay") then {["Init", _this] call compile preprocessFileLineNumbers "core\spectator\vip_asp\vip_asp_init.sqf"};
		if (isClass (configFile >> "CfgPatches" >> "ace_hearing")) then {ace_hearing_disableVolumeUpdate = true};

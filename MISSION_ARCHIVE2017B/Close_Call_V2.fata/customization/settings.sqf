if (isServer) then { //This scope is only for the server
	...
	[west, "US Army", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Taliban", "player"] call FNC_AddTeam; //Adds a ai team called MSV on side east

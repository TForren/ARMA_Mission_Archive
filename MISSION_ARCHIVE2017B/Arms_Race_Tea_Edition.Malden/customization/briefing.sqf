...
NEWTAB("I. Situation:")
Kamel Al-Adwar is a well known arms dealer who has been supplying Malden region with weapons and munitions to anti-US militias. BAF forces have been sent to hunt down Kamel and his supply truck. US Forces will find themselves up against an increasing amount of Malden militia as more towns are supplied by Kamel.
<br/><br/>
Civilian population is dense and intel on Kamel's whereabouts is sparse. BAF will need to inquire with the local populace for intel. Some civilians will know where he is, some might have an idea, and others might just get angry at you asking. Malden civilians have a heavily mixed opinion of US Forces.
<br/>
ENDTAB;
...
<br/>
Equipment:<br/>
Soviet-era small arms with a mix of Czechoslovakian and Belgium rifles, old Russian RPG-7 and 18s, soft armor technicals. Expected MANPADs at supplied towns.
<br/>
Strength:<br/>
...
<br/>
MDCOA:<br/>
Kamel's customers may rally against the BAF trying to find him.<br/>
...
a. Disposition:<br/>
BAF 1st Platoon staging at [<marker name='BAF'>048011</marker>].
<br/>
<br/>
...
Once a position is found, the BAF must quickly move to eliminate the threat before it moves again.
<br/>
<br/>
...
<br/>
c. Main Effort<br/>
Stop the supply of weapons to Malden militias.
<br/>
<br/>
...
case east: {
NEWTAB("I. Situation:")
We have some shipments to do in Malden. We must fill the orders out before the Americans get in the way.
<br/><br/>
...
<br/>
Equipment:<br/>
Modern BAF military small arms, armor, and equipment. Helicopter transport.
<br/>
<br/>
Strength:<br/>
1x air cavalary rifle platoon of ~25 soldiers.
<br/>
<br/>
Location:<br/>
...
NEWTAB("B. Friendly Forces:")
Kamel's Army and Malden Militia
<br/>
<br/>
a. Assets:<br/>
...
NEWTAB("II. Objective:")
Deliver weapons to the given towns as they come in (via task control). The arms truck will be loaded with ammo and cannot travel fast off-road.
ENDTAB;
...
<br/>
<br/>OPFOR Victory is achieved when 5 towns are supplied or BAF are at 75% casualties.
<br/>
<br/>BAF Victory is achieved When Kamel or his vehicle are eliminated.
<br/>

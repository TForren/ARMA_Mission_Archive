...
if (isServer) then
{
	...
	_possibleStarts = [(getmarkerpos "opStart1"),(getmarkerpos "opStart2"),(getmarkerpos "opStart3"),(getmarkerpos "opStart4"), (getmarkerpos "opStart5")];
	...
	[[armsVehicle,60,30]] call HZ_fnc_speedLimiter;
	...
	[armsVehicle, "Ammo"] call FNC_VehicleGearScript;

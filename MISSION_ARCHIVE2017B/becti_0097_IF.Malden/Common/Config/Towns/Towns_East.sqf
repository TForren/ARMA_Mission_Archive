with missionNamespace do {
	...
	EAST_SOLDIER_AA = ["rhs_vmf_flora_aa", 1];
	...
	EAST_SOLDIER_SNIPER = ["rhs_vmf_recon_marksman", 1];
	EAST_SOLDIER_MARKSMAN = ["rhs_vmf_recon_marksman", 1];
	...
	EAST_SOLDIERS_SPECOPS = [["rhs_vmf_flora_engineer", 1]];
	EAST_SOLDIERS_ENGINEER = [EAST_SOLDIER_ENGINEER, ["rhs_vmf_flora_engineer", 1]];
	EAST_SOLDIERS_SNIPERS = [EAST_SOLDIER_SNIPER, ["rhs_vmf_recon_marksman", 1], ["rhs_vmf_recon_marksman", 1]];
	EAST_SOLDIERS_MARKSMEN = [EAST_SOLDIER_MARKSMAN, ["rhs_vmf_recon_marksman", 1], ["rhs_vmf_flora_marksman", 1]];

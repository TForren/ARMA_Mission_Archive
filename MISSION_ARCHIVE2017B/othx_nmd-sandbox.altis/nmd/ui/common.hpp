...
* @Last Modified time: 2014-05-22 10:51:23
*/
...
class NMD_RscControlsGroup
{
	...
	h = 1;
	shadow = 0;
	class VScrollbar: NMD_ScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};
	class HScrollbar: NMD_ScrollBar
	{
		height = 0.028;
	};
	class Controls{};
...
class NMD_RscCombo
{
	...
	font = "PuristaMedium";
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)* 1)";
	class ComboScrollBar: NMD_ScrollBar
	{
		color[] = {1,1,1,1};
	};
	tooltipColorText[] = {1,1,1,1};
...
class NMD_RscListBox
{
	...
	tooltipColorBox[] = {1,1,1,1};
	tooltipColorShade[] = {0,0,0,0.65};
	class ListScrollBar: NMD_ScrollBar
	{
		color[] = {1,1,1,1};
		autoScrollEnabled = 1;
	};

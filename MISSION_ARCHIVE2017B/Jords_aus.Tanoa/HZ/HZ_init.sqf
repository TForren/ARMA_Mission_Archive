...
reinforcers = [reinforceVic1,reinforceVic2,reinforceVic3,reinforceVic4];
...
_alertHandle = [] spawn {
	while {!alerted} do {
		...
		} foreach ([leader garrisongroup1] + [leader garrisongroup2] + [leader garrisongroup3] + [leader garrisongroup4] + [leader garrisongroup5] + [leader garrisongroup6] + [leader garrisongroup7]);
		sleep 5;
	};
};

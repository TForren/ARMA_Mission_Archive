...
missionNamespace setVariable ["CTI_CO_CAMP", "Land_HBarrier_01_tower_green_F"];//--- Camp classname to be used.
...
missionNamespace setVariable ["CTI_CO_DEPOT", "Land_BagBunker_01_large_green_F"];//--- Town classname to be used.

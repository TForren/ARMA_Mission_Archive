if (isServer) then { //This scope is only for the server
	...
	[east, "Greek Insurgents", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east
...
//New end messages
victoryMessage = "MARSOC forces have destroyed the cache and have extracted from the AO. <br/><br/>BLUFOR VICTORY<br/>";
victoryMessage2 = "MARSOC forces have destroyed the cache but have yet to leave the AO. <br/><br/>MINOR BLUFOR VICTORY<br/>";
pyrrhic = "The cache is destroyed, but MARSOC have taken too many casualties. <br/><br/>PYRRHIC VICTORY<br/>";
failureMessage = "MARSOC have taken too many casualties to continue the mission. <br/><br/>INSURGENT VICTORY<br/>";

...
if (_adminState != 0 || _uid == "76561198013584551" || _uid == "76561197988578942") then {
	...
	<br/><execute expression='victoryMessage call FNC_EndMissionRequest'>Cache destroyed and extracted</execute>  
	<br/>
	<br/><execute expression='victoryMessage2 call FNC_EndMissionRequest'>Cache destroyed and no extraction</execute>  
	<br/>
	<br/><execute expression='pyrrhic call FNC_EndMissionRequest'>Cache destroyed and heavy casualties</execute>  
	<br/>

if (isServer) then { //This scope is only for the server
	...
	[west, "US Operators", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Guards", "player"] call FNC_AddTeam; //Adds a ai team called MSV on side east
...
victoryMessage = "BLUFOR have sucessfully completed 3 objectives.<br/><br/>BLUFOR OPERATOR VICTORY<br/>";
failureMessage = "BLUFOR have been eliminated.<br/><br/>OPFOR GUARD VICTORY<br/>";

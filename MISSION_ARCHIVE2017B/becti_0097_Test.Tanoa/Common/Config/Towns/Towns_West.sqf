with missionNamespace do {
	...
	WEST_SOLDIER_SNIPER = ["B_Sniper_F", 1];
	WEST_SOLDIER_MARKSMAN = ["B_Soldier_M_F", 1];
	WEST_SOLDIER_TEAMLEADER = ["B_Soldier_TL_F", 1];
	WEST_SOLDIER_HEAVYGUNNER = ["B_HeavyGunner_F", 1];
	...
	WEST_SOLDIERS_SNIPERS = [WEST_SOLDIER_SNIPER, ["B_Spotter_F", 1], ["B_ghillie_sard_F", 1]];
	WEST_SOLDIERS_MARKSMEN = [WEST_SOLDIER_MARKSMAN, ["B_Spotter_F", 1], ["B_Sharpshooter_F", 1]];

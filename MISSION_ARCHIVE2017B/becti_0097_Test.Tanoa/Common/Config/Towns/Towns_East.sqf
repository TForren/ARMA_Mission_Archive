with missionNamespace do {
	...
	EAST_SOLDIER_SNIPER = ["O_Sniper_F", 1];
	EAST_SOLDIER_MARKSMAN = ["O_Soldier_M_F", 1];
	EAST_SOLDIER_TEAMLEADER = ["O_Soldier_TL_F", 1];
	EAST_SOLDIER_HEAVYGUNNER = ["O_HeavyGunner_F", 1];
	...
	EAST_SOLDIERS_SNIPERS = [EAST_SOLDIER_SNIPER, ["O_Spotter_F", 1], ["O_ghillie_sard_F", 1]];
	EAST_SOLDIERS_MARKSMEN = [EAST_SOLDIER_MARKSMAN, ["O_Spotter_F", 1], ["O_Sharpshooter_F", 1]];

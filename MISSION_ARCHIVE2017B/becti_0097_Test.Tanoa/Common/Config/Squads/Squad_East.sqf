...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["O_Soldier_F", 5], ["O_soldier_AR_F", 2, 80], ["O_HeavyGunner_F", 1, 50], ["O_medic_F", 1], ["O_soldier_LAT_F", 1, 70], ["O_Soldier_GL_F", 2, 90], ["O_sniper_F", 1, 70], ["O_soldier_M_F", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1725];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_soldier_M_F", 2], ["O_Spotter_F", 1], ["O_Sharpshooter_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1300];
...
_p = _p		+ [[["O_sniper_F", 2], ["O_Spotter_F", 1], ["O_ghillie_sard_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1450];
_c = _c		+ ["InfantryAdvanced"];
_s = _s		+ [[]];
...
_p = _p		+ [[["O_APC_Wheeled_02_rcws_F", 1], ["O_APC_Tracked_02_cannon_F", 1, 80]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6400];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];

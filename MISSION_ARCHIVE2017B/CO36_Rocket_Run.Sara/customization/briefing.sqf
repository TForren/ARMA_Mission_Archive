...
1x Pro-RAQS Nationalist platoon 
<br/>
<br/>
...
<br/>
1x L-159 CAS Element suppourt from Saharani Royal Airforce
<br/>
...
<br/>
Pro-RAQS Nationalists will launch an assult upon the town of modesta and its surrounding area, then seize supplies from the nearby depot and extract with Air asset cover to the town of Everon
<br/>
<br/>
...
<br/>
<br/>Victory is achieved when Pro-RAQS Nationalists extract to the town of Modesta WITH minumum of 20 ammo supply crates and Fuel truck // put win condition here
<br/>Defeat occurs when 90% Pro-RAQS Nationalists forces eleminated//put failure conditions here, example - Russian forces secure the train (after 30 minutes of uninterrupted occupation), USMC suffer too many casualties(80%), or time limit is reached.<br/>
<br/>
ENDTAB;

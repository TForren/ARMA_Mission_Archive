...
bulletWindSimulationServer=compile BWServer;
while{true}do{
{_hasWind=_x getVariable["hasWind",0];
	if(_hasWind != 1)then{
	_x addEventHandler["Fired","[_this]spawn bulletWindSimulationServer"];
	_x setVariable["hasWind",1,false];};

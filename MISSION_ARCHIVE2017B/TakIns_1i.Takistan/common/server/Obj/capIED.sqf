...
[west,["t3"],["Intel reports that the Taliban are hiding an IED maker in a factory just to the north of Feruz Abad.  Kill him.","Capture IED Maker","sideMarker"],getMarkerPos "sideMarker",true,1,true,"Kill",true]call BIS_fnc_taskCreate;

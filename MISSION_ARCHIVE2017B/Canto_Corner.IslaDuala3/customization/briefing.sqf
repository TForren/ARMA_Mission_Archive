...
<br/>
<br/>BAF is achieved when the weapons cache is secured.
<br/>
...
if (_adminState != 0 || _uid == "76561198013584551" || _uid == "76561197988578942") then {
	...
	<br/><execute expression='victoryMessage call FNC_EndMissionRequest'>Cache secured</execute>  
	<br/>
	<br/><execute expression='failureMessage call FNC_EndMissionRequest'>Heavy BAF casualtiesr</execute>
	ENDTAB;
};

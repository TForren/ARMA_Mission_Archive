...
//New end messages
victoryMessage = "The insurgents have made it out and the AA is destroyed. <br/><br/>INSURGENT VICTORY<br/>";
victoryMessage2 = "The insurgents were unable to make it out but the AA was destroyed. <br/><br/>STILL A VICTORY<br/>";
stalemate = "The insurgents were escaped but AA is still active. <br/><br/>STALEMATE<br/>";
failureMessage = "The insurgents were unable to escape and the AA is still active. <br/><br/>CSAT VICTORY<br/>";

...
Royal Army Corps of Sahrani Mechanized platoon, with two rifle squads and a weapons squad, and BMP-2 IFVs. Additionally, one BRM-1K has been allocated to us for support.//The object for the deploying force, example - USMC aboard the USS Throne are to secure and destroy the experimental T-80s.
<br/>
<br/>
...
RACS:<br/>
Two BMP-2 IFVs<br/>
One BRM-1k w/TOW Missile System in Cargo<br/>
One Land Rover Transport<br/>
...
<br/> HQ- Stand
<br/>1st Platoon Infantry Squads- Crawler 1-2
<br/>1st Platoon Vehicles- Crate 1-2
<br/>BRM-1K- Mara
ENDTAB;

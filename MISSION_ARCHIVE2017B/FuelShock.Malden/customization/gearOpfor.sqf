// Info: RUS VDV Opfor Loadouts - Updated 15/08/2017
...
// Primary
#define O_rifle_r "rhs_weap_ak74n","rhs_weap_ak74n"
#define O_rifle "rhs_weap_ak74n"
#define O_rifle2 "rhs_weap_ak74n"
#define O_glrifle_r "rhs_weap_ak74n_gp25","rhs_weap_ak74n_gp25"
#define O_glrifle "rhs_weap_ak74n_gp25"
#define O_glrifle2 "rhs_weap_ak74n_gp25"
...
//Uniform              
#define O_default_uniform "CORX_Gorka_SSautumn"
#define O_pilot_uniform "rhs_uniform_df15"

//Headgear
#define O_default_headgear_r "rhs_6b7_1m_emr","rhs_6b7_1m_emr_ess"
#define O_vcrew_headgear "rhs_tsh4"
#define O_officer_headgear "rhs_fieldcap_helm_digi"
...
//Vests
#define O_vest_default "rhs_6Sh92"
#define O_vest_ftl "rhs_6sh92_vog"
#define O_vest_medic "rhs_6Sh92"
#define O_vest_grenadier "rhs_6sh92_vog"
#define O_vest_mg "rhs_6Sh92"
#define O_vest_sniper "rhs_6Sh92"
#define O_vest_vc "rhs_6Sh92"
#define O_vest_leader "rhs_6Sh92"
#define O_vest_officer "rhs_6Sh92"
#define O_vest_psgt "rhs_6Sh92"
...
case "O_PC": {
	...
	if ((random 1.0) < 0.5) then {["rhs_beanie_green","rhs_beanie"] call FNC_AddItemRandom;};
	...
	//Attachments
	if ((random 1.0) < 0.50) then {
		[O_red_dot2] call FNC_AddItem;
	} else {
		if ((random 1.0) < 0.50) then {
		[O_rifle_scope2] call FNC_AddItem;
		};
	};
...
case "O_SL": {
	...
	[O_frag,1,"uniform"] call FNC_AddItem;
	[O_maptools,1,"uniform"] call FNC_AddItem;
	[O_cuffs,1,"uniform"] call FNC_AddItem;
...
case "O_GRE": {
	...
	//Vest
	[O_riflemag,6,"backpack"] call FNC_AddItem;
	[O_riflemag_tr,2,"backpack"] call FNC_AddItem;
	[O_glbouncehe,12,"backpack"] call FNC_AddItem;
	[O_glsmokewhite,2,"backpack"] call FNC_AddItem;
	[O_glsmokered,2,"backpack"] call FNC_AddItem;
	[O_glsmokeinstant,2,"backpack"] call FNC_AddItem;

	//Assigned Items
	O_default_equipment;
   
	//Weapons
	[O_glrifle_r] call FNC_AddItemRandom;
	[O_rsp] call FNC_AddItem;
...
case "O_RIF": {
	["G_Balaclava_oli"] call FNC_AddItem;
	if ((random 1.0) < 0.5) then {if ((random 1.0) < 0.5) then {["rhs_beanie_green","rhs_beanie"] call FNC_AddItemRandom;};};
	[O_default_uniform] call FNC_AddItem;
	[O_vest_default] call FNC_AddItem;
...
case "O_MARK": {
	...
	//Uniform
	[O_dmrmag,6,"uniform"] call FNC_AddItem;

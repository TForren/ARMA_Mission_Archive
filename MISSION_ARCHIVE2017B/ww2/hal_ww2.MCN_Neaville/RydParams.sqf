...
RHQ_Recon = ["LIB_SOV_scout_sergeant","LIB_SOV_scout_smgunner","LIB_SOV_scout_mgunner","LIB_SOV_scout_sniper"];
RHQ_Snipers = ["LIB_SOV_scout_sniper"];
RHQ_Cars = ["LIB_SOV_M3_Halftrack"];
RHQ_Cargo = ["LIB_SOV_M3_Halftrack"];
RHQ_Air = ["LIB_P39","LIB_Pe2"];
RHQ_BAir = ["LIB_Pe2"];
RHQ_FO = ["LIB_SOV_scout_sniper","LIB_NKVD_first_lieutenant","LIB_SOV_sergeant"];
RHQ_Inf = ["LIB_SOV_sergeant","LIB_SOV_smgunner","LIB_SOV_mgunner","LIB_SOV_medic","LIB_SOV_AT_grenadier","LIB_SOV_LC_rifleman","LIB_SOV_rifleman","LIB_NKVD_first_lieutenant","LIB_NKVD_lieutenant","LIB_SOV_scout_sergeant","LIB_SOV_scout_smgunner","LIB_SOV_scout_mgunner","LIB_SOV_scout_sniper","LIB_SOV_assault_smgunner"];
RHQ_HArmor= ["LIB_T34_76","LIB_JS2_43"];


//excludes
RHQs_Cars = ["LIB_US6_BM13"];

//support
RydHQ_SupportWP = true;

RHQ_Support = ["LIB_Zis6_Parm","LIB_Zis5v_Fuel","LIB_US6_Ammo"];
RHQ_Rep = ["LIB_Zis6_Parm"];
RHQ_Fuel = ["LIB_Zis5v_Fuel"];
RHQ_Ammo = ["LIB_US6_Ammo"];
...
RydHQB_ReconReserve = 0;
RydHQC_ReconReserve = 0;
...
RydHQ_Add_OtherArty = [
	[["lib_bm37"],["lib_8rnd_81mmhe_grwr34","lib_8rnd_81mmhe_grwr34","lib_8rnd_81mmhe_grwr34","",""]],
	[["lib_us6_bm13"],["Lib_16rnd_bm13","Lib_16rnd_bm13","Lib_16rnd_bm13","",""]]
];

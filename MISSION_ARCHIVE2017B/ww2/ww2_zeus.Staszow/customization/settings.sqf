...
if (!isDedicated) then { //This scope is only for the player
	...
	FW_RespawnTickets = 400;//If respawn is enabled you must create empty game logics, for respawn points, following the name format fw_side_respawn. Example: fw_west_respawn
};

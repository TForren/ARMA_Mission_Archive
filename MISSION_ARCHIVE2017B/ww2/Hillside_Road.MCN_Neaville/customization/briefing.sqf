...
NEWTAB("I. Situation:")
<br/>
<br/>German outpost lines setup to the west of Neaville are holding back allied advance.
<br/><br/>
<font color='#FFA500'>c. Area of Operations:</font><br/>
Semi-clear Skies. Midday. Open ground with little hard cover.
<br/><br/>
ENDTAB;
...
Reduced platoon in and around the outpost line. No expected reinforcements.
<br/><br/>
...
To eliminate enemy Defensive positions.
<br/><br/>
...
NEWTAB("II. Mission:")
ASSAULT and CLEAR the German outpost line at LC013031.
ENDTAB;

NEWTAB("III. Execution:")

<font color='#FFA500'>a. Concept of the Operation</font><br/>
US Forces will move around the North Western flank of the mine fields to assault the outpost line. 
<br/>
<br/>
ENDTAB;

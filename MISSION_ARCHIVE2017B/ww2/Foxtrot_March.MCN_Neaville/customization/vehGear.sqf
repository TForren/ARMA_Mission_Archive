...
switch (_type) do {
	...
	case "Sherman": {
		...
		["LIB_15Rnd_762x33", 20] call FNC_AddItemVehicle;
		["LIB_30Rnd_45ACP", 20] call FNC_AddItemVehicle;
		["LIB_5Rnd_762x63", 20] call FNC_AddItemVehicle;
		["LIB_20Rnd_762x63", 20] call FNC_AddItemVehicle;

...
_u = _u		+ ["B_T_sniper_F"];  
_u = _u		+ ["B_T_ghillie_sard_F"];
_u = _u		+ ["B_T_ghillie_lsh_F"];
_u = _u		+ ["B_T_ghillie_ard_F"];
...
_u = _u		+ ["B_T_recon_TL_F"];
_u = _u		+ ["B_T_recon_M_F"];
_u = _u		+ ["B_T_Recon_Sharpshooter_F"];

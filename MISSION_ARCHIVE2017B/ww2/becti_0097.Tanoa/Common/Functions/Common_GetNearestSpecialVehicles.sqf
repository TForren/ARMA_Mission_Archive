...
} forEach ((_unit nearEntities [["Car", "Ship", "Motorcycle", "Tank", "Air", "Support"], _range]) + (nearestObjects [_unit, ["StaticWeapon", "Thing"], _range])); //--- Huron/Taru pods arent returned with near entities?

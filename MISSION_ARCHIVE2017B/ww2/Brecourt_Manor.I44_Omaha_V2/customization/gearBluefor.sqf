...
#define B_default_headgear "H_LIB_US_AB_Helmet_Clear_1", "H_LIB_US_AB_Helmet_Clear_2","H_LIB_US_AB_Helmet_Clear_3","H_LIB_US_AB_Helmet","H_LIB_US_AB_Helmet_2","H_LIB_US_AB_Helmet_Jump_1","H_LIB_US_AB_Helmet_Jump_2","H_LIB_US_AB_Helmet_3","H_LIB_US_AB_Helmet_4","H_LIB_US_AB_Helmet_5","H_LIB_US_AB_Helmet_Plain_1","H_LIB_US_AB_Helmet_Plain_2","H_LIB_US_AB_Helmet_Plain_3"
...
//Platoon Leader
case "B_PC": {
	["H_LIB_US_AB_Helmet_CO_2","H_LIB_US_AB_Helmet_CO_1"] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42_NCO"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Carbine_nco"] call FNC_AddItem;
	...
	["LIB_M1A1_Carbine"] call FNC_AddItem;
...
case "B_SGT": {
	...
	["U_LIB_US_AB_Uniform_M42_NCO"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Thompson_nco"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
	//Uniform
	["LIB_30Rnd_45ACP",2,"uniform"] call FNC_AddItem;
	["ACE_fieldDressing",3,"uniform"] call FNC_AddItem; 
	...
	//backpack
	["LIB_30Rnd_45ACP",2,"backpack"] call FNC_AddItem;
...
case "B_MSG": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Carbine"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
...
//Medic
case "B_MED": {
	["H_LIB_US_AB_Helmet_Medic_1","H_LIB_US_AB_Helmet_Medic_1"] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42_Medic"] call FNC_AddItem;
...
//Squad Leader
case "B_SL": {
	["H_LIB_US_AB_Helmet_NCO_1","H_LIB_US_AB_Helmet_NCO_2"] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42_NCO"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Garand"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
	...
	["LIB_US_M18",2,"uniform"] call FNC_AddItem; 
...
case "B_ASL": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42_corporal"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Garand"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
...
case "B_AR": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M43"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Bar"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
	...
	//Vest
	["LIB_50Rnd_762x63",2,"vest"] call FNC_AddItem; 
	["LIB_7Rnd_45ACP",3,"vest"] call FNC_AddItem; 
	["LIB_US_M18",1,"vest"] call FNC_AddItem; 
	["LIB_US_Mk_2",1,"vest"] call FNC_AddItem;
	
	//backpack
	["LIB_50Rnd_762x63",4,"backpack"] call FNC_AddItem;

	//Assigned Items
	B_default_equipment;

	//Weapons
	["LIB_M1919A4"] call FNC_AddItem;
	["LIB_Colt_M1911"] call FNC_AddItem;
};
...
case "B_AAR": {
	...
	["V_LIB_US_AB_Vest_Garand"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	["LIB_M2_Tripod"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
	...
	["ACE_tourniquet",1,"uniform"] call FNC_AddItem;
	["ACE_fieldDressing",3,"uniform"] call FNC_AddItem; 
	["LIB_15Rnd_762x33",5,"uniform"] call FNC_AddItem; 
	
	//Vest
	["ACE_Sandbag_empty",1,"vest"] call FNC_AddItem; 
	["LIB_15Rnd_762x33",4,"vest"] call FNC_AddItem; 
	["LIB_US_M18",2,"vest"] call FNC_AddItem; 
	["LIB_US_Mk_2",2,"vest"] call FNC_AddItem;
...
case "B_GRE": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_AB_Uniform_M42_corporal"] call FNC_AddItem;
	["V_LIB_US_AB_Vest_Grenadier"] call FNC_AddItem;
	["B_LIB_US_M36"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
	...
	//backpack
	["LIB_1Rnd_G_Mk2",10,"backpack"] call FNC_AddItem; 
	["LIB_US_Mk_2",2,"backpack"] call FNC_AddItem; 
	["LIB_ACC_GL_M7",1,"backpack"] call FNC_AddItem; 
...
case "B_HTC": {
	...
	["ACE_tourniquet",1,"uniform"] call FNC_AddItem;
	["ACE_fieldDressing",3,"uniform"] call FNC_AddItem; 
	["LIB_7Rnd_45ACP",3,"uniform"] call FNC_AddItem; 

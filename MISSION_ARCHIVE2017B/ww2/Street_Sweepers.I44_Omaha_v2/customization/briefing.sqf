...
NEWTAB("I. Situation:")
<br/>
<br/>Wehrmacht Heer have setup mortar positions near the church. Although man power is limited in town, enemy reinforcements are expected from the west.
<br/><br/>
...
Reduced platoon in-town. Unknown exact reinforcement strength. Expected reduced company.
<br/><br/>
...
To eliminate enemy mortar position and hold new territory.
<br/><br/>
...
NEWTAB("II. Mission:")
CLEAR the town to DESTROY the mortar site and DEFEND from incoming reinforcements.
ENDTAB;

NEWTAB("III. Execution:")

<font color='#FFA500'>a. Concept of the Operation</font><br/>
US Forces will sweep the streets of the town for all enemy contact to destroy the mortar site. After which, enemy reinforcements are expected and must be held off.
<br/>
<br/>
ENDTAB;

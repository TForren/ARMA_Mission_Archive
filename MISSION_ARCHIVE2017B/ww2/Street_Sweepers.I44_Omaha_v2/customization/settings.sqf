if (isServer) then { //This scope is only for the server
	...
	[west, "Wehrmacht", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[resistance, "US Forces", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east
...
//New end messages
victoryMessage = "The US Forces have destroyed the mortar site and held off the reinforcements. <br/><br/>US VICTORY<br/>";

...
missionNamespace setVariable [format["CTI_%1_HQ", _side], "LIB_SOV_M3_Halftrack"];
...
_classes = _classes 		+ [["BTR90_HQ_unfolded", "Land_Cargo40_brick_red_F"]];
...
_classes = _classes 		+ [["RU_WarfareBBarracks", "Land_Cargo20_brick_red_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [60];
...
_classes = _classes 		+ [["RU_WarfareBLightFactory", "Land_Cargo20_brick_red_F"]];
_prices = _prices 			+ [600];
_times = _times 			+ [80];
...
_classes = _classes 		+ [["RU_WarfareBUAVterminal", "Land_Cargo20_brick_red_F"]];
...
_classes = _classes 		+ [["RU_WarfareBHeavyFactory", "Land_Cargo40_brick_red_F"]];
...
_classes = _classes 		+ [["RU_WarfareBAircraftFactory", "Land_Cargo40_brick_red_F"]];
...
_classes = _classes 		+ [["RU_WarfareBVehicleServicePoint", "Land_Cargo20_brick_red_F"]];
_prices = _prices 			+ [200];
_times = _times 			+ [40];
_placements = _placements 	+ + [[180, 20]];
_helper = _helper			+ [["Sign_Arrow_Large_F", 0]];

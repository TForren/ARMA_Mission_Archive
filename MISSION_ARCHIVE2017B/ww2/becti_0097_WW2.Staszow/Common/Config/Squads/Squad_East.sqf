...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["LIB_SOV_rifleman", 5], ["O_soldier_AR_F", 2, 80], ["LIB_SOV_mgunner", 1, 50], ["LIB_SOV_medic", 1], ["O_soldier_LAT_F", 1, 70], ["LIB_SOV_rifleman", 2, 90], ["LIB_SOV_scout_sniper_autumn", 1, 70], ["LIB_SOV_p_officer", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1725];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAT"];
_t = _t		+ ["Infantry - AT"];
_p = _p		+ [[["O_soldier_AT_F", 5, 85], ["LIB_SOV_medic", 1], ["O_soldier_LAT_F", 3, 75]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [4865];
_c = _c		+ ["InfantryAT"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAA"];
_t = _t		+ ["Infantry - AA"];
_p = _p		+ [[["O_soldier_AA_F", 5, 85], ["LIB_SOV_medic", 1], ["O_soldier_LAT_F", 2, 60]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [2415];
_c = _c		+ ["InfantryAA"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_SOV_p_officer", 2], ["O_Spotter_F", 1], ["LIB_SOV_scout_rifleman_autumn", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1300];
...
_p = _p		+ [[["LIB_SOV_scout_sniper_autumn", 2], ["O_Spotter_F", 1], ["LIB_SOV_scout_sniper_autumn", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1450];
_c = _c		+ ["InfantryAdvanced"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_Scout_M3_FFV", 3], ["LIB_Scout_M3_FFV", 2, 75]]];
_f = _f		+ [CTI_LIGHT];
_m = _m		+ [6500];
_c = _c		+ ["Motorized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_Scout_M3", 1], ["LIB_SdKfz251_captured", 1, 80]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6400];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_SdKfz251_captured_FFV", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [5650];
_c = _c		+ ["AntiAir"];
_s = _s		+ [[]];

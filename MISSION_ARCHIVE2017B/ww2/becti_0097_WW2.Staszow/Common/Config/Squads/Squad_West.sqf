...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["LIB_GER_Soldier2_base", 5], ["B_soldier_AR_F", 2, 80], ["B_HeavyGunner_F", 1, 50], ["B_medic_F", 1], ["B_soldier_LAT_F", 1, 70], ["B_Soldier_GL_F", 2, 90], ["LIB_GER_scout_sniper", 1, 70], ["B_soldier_M_F", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1725];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_GER_scout_sniper", 2], ["B_Spotter_F", 1], ["B_ghillie_sard_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1450];
_c = _c		+ ["InfantryAdvanced"];
_s = _s		+ [[]];
...
// _p = _p		+ [[["LIB_opelblitz_tent_y_camo", 1]]];
// _f = _f		+ [CTI_LIGHT];
// _m = _m		+ [1000];
...
_p = _p		+ [[["LIB_SdKfz251", 3], ["LIB_SdKfz251", 2, 75]]];
_f = _f		+ [CTI_LIGHT];
_m = _m		+ [6500];
_c = _c		+ ["Motorized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["LIB_SdKfz251_FFV", 1], ["LIB_SdKfz251", 1, 80]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6100];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_v = _v		+ ["Armored"];
_t = _t		+ ["Armored - MBT"];
_p = _p		+ [[["LIB_PzKpfwIV_H", 1], ["LIB_PzKpfwV", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [15150];
_c = _c		+ ["Armored"];
_s = _s		+ [[]];

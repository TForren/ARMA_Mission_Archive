/*
  ...
  # EXAMPLE #
	_unit = ["LIB_GER_Soldier2_base", group player, getPos player, CTI_P_SideJoined] call CTI_CO_FNC_CreateUnit; 
	  -> Create a "LIB_GER_Soldier2_base" at the player's position
	_unit = ["LIB_GER_Soldier2_base", group player, getPos player, CTI_P_SideJoined, true, "NONE"] call CTI_CO_FNC_CreateUnit; 
	  -> Create a "LIB_GER_Soldier2_base" at the player's position, initialize it over the network and ignore the formation on creation
*/

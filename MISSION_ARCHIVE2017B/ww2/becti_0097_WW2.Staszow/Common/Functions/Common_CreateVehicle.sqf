/*
  ...
  # EXAMPLE #
	_vehicle = ["LIB_Kfz1", getPos player, 0, CTI_P_SideJoined] call CTI_CO_FNC_CreateVehicle; 
	  -> Create a "LIB_Kfz1" at the player's position facing North on the player's initial side
	_vehicle = ["LIB_Kfz1", getPos player, 180, CTI_P_SideJoined, true, true] call CTI_CO_FNC_CreateVehicle; 
	  -> Create a locked and handled "LIB_Kfz1" at the player's position facing South on the player's initial side
*/

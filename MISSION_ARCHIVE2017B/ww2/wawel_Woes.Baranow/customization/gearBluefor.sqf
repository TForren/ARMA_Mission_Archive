...
#define B_default_headgear "H_LIB_US_Helmet", "H_LIB_US_Helmet_Net_ns","H_LIB_US_Helmet_Net_os","H_LIB_US_Helmet_Net","H_LIB_US_Helmet_ns","H_LIB_US_Helmet_os"
...
case "B_PC": {
	...
	["LIB_1Rnd_flare_yellow",1,"vest"] call FNC_AddItem;
	["LIB_1Rnd_flare_green",1,"vest"] call FNC_AddItem;
	["LIB_1Rnd_flare_red",1,"vest"] call FNC_AddItem;
...
case "B_SGT": {
	...
	["U_LIB_US_Sergant"] call FNC_AddItem;
	...
	//backpack
	["LIB_1Rnd_flare_yellow",1,"backpack"] call FNC_AddItem;
	["LIB_1Rnd_flare_green",1,"backpack"] call FNC_AddItem;
	["LIB_1Rnd_flare_red",1,"backpack"] call FNC_AddItem;
...
case "B_ASL": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_Snipe"] call FNC_AddItem;
	["V_LIB_US_Vest_Garand"] call FNC_AddItem;
	if (random 1 > 0.5) then {
		[B_glasses] call FNC_AddItemRandom;
	};
...
case "B_AR": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_Private_1st"] call FNC_AddItem;
...
case "B_GRE": {
	[B_default_headgear] call FNC_AddItemRandom;
	["U_LIB_US_Corp"] call FNC_AddItem;

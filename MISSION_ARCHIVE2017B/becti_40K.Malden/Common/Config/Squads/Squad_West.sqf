...
_v = _v		+ ["Infantry"];
_t = _t		+ ["Infantry"];
_p = _p		+ [[["DKoK_GM_1489th", 5], ["DKoK_Eng_1489th", 2, 80], ["DKoK_Gren_1489th", 1, 50], ["DKoK_GM_1489th", 1], ["DKoK_Gren_1489th_AT", 1, 70], ["DKoK_Gren_1489th", 2, 90], ["DKoK_GM_WM_1489th", 1, 70], ["DKoK_GM_1489th", 1, 55]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1725];
_c = _c		+ ["Infantry"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAT"];
_t = _t		+ ["Infantry - AT"];
_p = _p		+ [[["B_soldier_AT_F", 5, 85], ["DKoK_GM_1489th", 1], ["DKoK_Gren_1489th_AT", 3, 75]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [4865];
_c = _c		+ ["InfantryAT"];
_s = _s		+ [[]];
...
_v = _v		+ ["InfantryAA"];
_t = _t		+ ["Infantry - AA"];
_p = _p		+ [[["B_soldier_AA_F", 5, 85], ["DKoK_GM_1489th", 1], ["DKoK_Gren_1489th_AT", 2, 60]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [2415];
_c = _c		+ ["InfantryAA"];
_s = _s		+ [[]];
...
_p = _p		+ [[["DKoK_GM_1489th", 2], ["B_Spotter_F", 1], ["B_Sharpshooter_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1300];
...
_p = _p		+ [[["DKoK_GM_WM_1489th", 2], ["B_Spotter_F", 1], ["B_ghillie_sard_F", 1]]];
_f = _f		+ [CTI_BARRACKS];
_m = _m		+ [1450];
_c = _c		+ ["InfantryAdvanced"];
_s = _s		+ [[]];
...
_p = _p		+ [[["_1490thChimAuto", 3], ["_1490thChimAuto", 2, 75]]];
_f = _f		+ [CTI_LIGHT];
_m = _m		+ [6500];
_c = _c		+ ["Motorized"];
_s = _s		+ [[]];
...
_p = _p		+ [[["_1490thChimAuto", 1], ["_1490thChimAuto", 1, 80]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [6100];
_c = _c		+ ["Mechanized"];
_s = _s		+ [[]];
...
_v = _v		+ ["Armored"];
_t = _t		+ ["Armored - MBT"];
_p = _p		+ [[["LRMKIV_1490th_1", 1], ["LRMKIV_1490th_1", 1]]];
_f = _f		+ [CTI_HEAVY];
_m = _m		+ [15150];
_c = _c		+ ["Armored"];
_s = _s		+ [[]];

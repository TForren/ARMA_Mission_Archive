/*
  ...
  # EXAMPLE #
	_unit = ["DKoK_GM_1489th", group player, getPos player, CTI_P_SideJoined] call CTI_CO_FNC_CreateUnit; 
	  -> Create a "DKoK_GM_1489th" at the player's position
	_unit = ["DKoK_GM_1489th", group player, getPos player, CTI_P_SideJoined, true, "NONE"] call CTI_CO_FNC_CreateUnit; 
	  -> Create a "DKoK_GM_1489th" at the player's position, initialize it over the network and ignore the formation on creation
*/

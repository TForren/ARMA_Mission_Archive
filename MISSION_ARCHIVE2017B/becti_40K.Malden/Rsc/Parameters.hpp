class Params {
	...
	class CTI_ECONOMY_STARTUP_FUNDS_EAST_COMMANDER {
		...
		values[] = {9000,15000,20000,25000,30000,35000,40000,45000,50000,60000,80000,9999999};
		texts[] = {"$9000","$15000","$20000","$25000","$30000","$35000","$40000","$45000","$50000","$60000","$80000","$9999999"};
		default = 9999999;
	};
	class CTI_ECONOMY_STARTUP_FUNDS_EAST {
		title = "INCOME: Starting Funds (East Players)";
		values[] = {900,1500,2400,3200,6000,8000,10000,12500,15000,20000,30000,9999999};
		texts[] = {"$900","$1500","$2400","$3200","$6000","$8000","$10000","$12500","$15000","$20000","$30000","$9999999"};
		default = 30000;
	};
	class CTI_ECONOMY_STARTUP_SUPPLY_EAST {
		title = "INCOME: Starting Supply (East)";
		values[] = {1200,2400,3600,4800,6000,7200,8400,9600,40000,999999};
		texts[] = {"S1200","S2400","S3600","S4800","S6000","S7200","S8400","S9600","S40000","$999999"};
		default = 999999;
	};

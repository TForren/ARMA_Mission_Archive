CTI_UI_Upgrade_LoadUpgradeInfo = {
	private ["_funds", "_index", "_upgrade_current", "_upgrade_label", "_upgrade_labels", "_upgrade_level", "_upgrade_prices", "_upgrade_time", "_upgrades"];
	_index = _this;
	...
	_upgrade_prices = ((missionNamespace getVariable Format["CTI_%1_UPGRADES_COSTS", CTI_P_SideJoined]) select _index) select _upgrade_current;
	...
	if (_upgrade_current < _upgrade_level) then {
		...
		if (_supplyActive) then {
			((uiNamespace getVariable "cti_dialog_ui_upgrademenu") displayCtrl 250004) ctrlSetStructuredText parseText format["<t color='#bae8ff' shadow='1'>Upgrade Level :</t><t shadow='1' align='right'><t color='#F5D363'>%1</t>/<t color='#F5D363'>%2</t></t><br /><t color='#bae8ff' shadow='1'>Needed Funds :</t><t shadow='1' align='right'><t color='#F5D363'>%3</t>/<t color='%4'>%5</t> $</t><br /><t color='#bae8ff' shadow='1'>Needed Supply :</t><t shadow='1' align='right'><t color='#F5D363'>%6</t>/<t color='%7'>%8</t> S</t><br /><t color='#bae8ff' shadow='1'>Needed Time :</t><t shadow='1' align='right'><t color='#F5D363'>%9</t> Seconds</t>", _upgrade_current, _upgrade_level, (_upgrade_prices select 1), if(_funds >= (_upgrade_prices select 1)) then {'#76F563'} else {'#F56363'}, _funds, (_upgrade_prices select 0), if(_supply >= (_upgrade_prices select 0)) then {'#76F563'} else {'#F56363'}, _supply,    _upgrade_time];
		} else {
			((uiNamespace getVariable "cti_dialog_ui_upgrademenu") displayCtrl 250004) ctrlSetStructuredText parseText format["<t color='#bae8ff' shadow='1'>Upgrade Level :</t><t shadow='1' align='right'><t color='#F5D363'>%1</t>/<t color='#F5D363'>%2</t></t><br /><t color='#bae8ff' shadow='1'>Needed Funds :</t><t shadow='1' align='right'><t color='#F5D363'>%3</t>/<t color='%4'>%5</t> $</t><br /><t color='#bae8ff' shadow='1'>Needed Time :</t><t shadow='1' align='right'><t color='#F5D363'>%6</t> Seconds</t>", _upgrade_current, _upgrade_level, (_upgrade_prices select 1), if(_funds >= (_upgrade_prices select 1)) then {'#76F563'} else {'#F56363'}, _funds, _upgrade_time];
		};

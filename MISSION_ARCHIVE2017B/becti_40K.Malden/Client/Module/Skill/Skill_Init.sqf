...
CTI_SK_ENGINEERS = ['B_engineer_F','rhs_vmf_flora_engineer','I_engineer_F'];
CTI_SK_OFFICERS = ['B_officer_F','rhs_vmf_flora_sergeant','I_officer_F'];
CTI_SK_SOLDIERS = ['B_Soldier_TL_F','O_Soldier_TL_F','I_Soldier_TL_F'];
CTI_SK_SPECOPS = [];
CTI_SK_SPOTTERS = ['B_sniper_F','rhs_vmf_recon_marksman','I_sniper_F'];
CTI_SK_SABOTEUR = [];

if (isServer) then { //This scope is only for the server
	...
	FW_TimeLimitMessage = "TIME LIMIT REACHED! MARSOC must extract before the sun rises and becomes too dangerous."; //The message displayed when the time runs out
	...
	[independent, "Greek Insurgents", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east

...
HZ_fnc_nightBunker = compile preprocessfilelinenumbers "HZ\HZ_fnc_nightBunker.sqf";

if (isServer) then {

garrisonUnits = (units manualGarrisonLead1) + (units manualGarrisonLead2);
heloCall = false;

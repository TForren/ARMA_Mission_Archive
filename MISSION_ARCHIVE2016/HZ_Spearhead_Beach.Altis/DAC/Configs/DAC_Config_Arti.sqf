...
//-------------------------------------------------------------------------------------------------------------------------
	...
	{		//""
		_set0  = [20,2,0,60];
		_set1  = [2,0.1,10,[],3,30];
		_set2  = [80,200,10,500,3,4,1]; //HelicopterExploBig M_Scalpel_AT rhs_ammo_3UOF191_airburst
		_set3  = [["RHS_BM21_MSV_01",["HelicopterExploBig"]],["rhs_2s3_tv",["HelicopterExploBig"]]];
		_set4  = [40,120,0];
		_set5  = [10,80,1];
		_set6  = [10,80,1];
		_set7  = [0.1,0.5,0];

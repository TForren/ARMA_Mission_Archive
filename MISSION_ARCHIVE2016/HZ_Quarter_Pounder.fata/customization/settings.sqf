...
if (isServer) then { //This scope is only for the server
	...
	[east, "Insurgent Uprising", "ai"] call FNC_AddTeam; //Adds a player team called USA on side west
	[independent, "Tottah Civilians", "ai"] call FNC_AddTeam; //Adds a player team called USA on side west

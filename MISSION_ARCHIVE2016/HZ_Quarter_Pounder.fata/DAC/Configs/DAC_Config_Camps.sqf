...
//------------------------------------Russian Camp-----------------------------------------------------------
	case 4:
	{
		_campBasic     = ["CUP_A2_wf_barracks_east",["CUP_A2_wf_vehicle_service_point_east",0,-15,-50],["CUP_A2_wf_uav_terminal_east",10,10,120],["Logic",10,15,0],0];
		_campAmmo      = [];
		_campStatic    = [["rhs_KORD_high_VDV", -10, 9, 0, "rhs_msv_rifleman"]]; //["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]
		_campAddUnit   = ["rhs_msv_machinegunner","rhs_msv_officer"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];

...
if((_DAC_WP_Typ < 5) && (_DAC_WP_Typ >= 0)) then
{
	switch (_DAC_WP_Nr) do
	{
		...
		case 4:	{ //==========M=I=N=N=E=E=E============
					//----------------- #Sol----#Veh----#Tan----#Air----#Camp----;
					_CheckRadius1 	= [	0,		0,		0,		0,		1		];
					_CheckRadius2 	= [ 0,		0,		0,		0,		10		];
					_checkAreaH   	= [	50,		50,		50,		50,		3		];
					_checkMaxH    	= [	5000,	5000,	5000,	5000,	5000	];
					_checkMinH    	= [	5,		5,		3,		5,		5		];
					_checkNear    	= [	0,		0,		0,		0,		100		];
					_checkObjH1    	= [	5,		0.1,	0.1,	8,		20		];
					_checkObjH2    	= [	50,		50,		5,		5,		20		];
		...
		case 6:	{	//Config for city generation. tan for large, veh for small, sol for debris
					//----------------- #Sol----#Veh----#Tan----#Air----#Camp----;
					_CheckRadius1 	= [	0,		0,		20,		0,		1		];
					_CheckRadius2 	= [ 2,		7,		20,		0,		10		];
					_checkAreaH   	= [	2,		7,		20,		50,		3		];
					_checkMaxH    	= [	5000,	5000,	5000,	5000,	5000	];
					_checkMinH    	= [	5,		5,		3,		5,		5		];
					_checkNear    	= [	2,		7,		20,		0,		100		];
					_checkObjH1    	= [	5,		0.1,	0.1,	8,		20		];
					_checkObjH2    	= [	50,		50,		5,		5,		20		];
					_checkCount   	= [	500,	500,	500,	500,	500		];
					_checkResol   	= [	18,		18,		18,		18,		18		];

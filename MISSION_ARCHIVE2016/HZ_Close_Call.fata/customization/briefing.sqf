...
case west: { //If player is west he receives this briefing
	...
	Insurgents are highly likely to use the rooftops to their advantage. Be aware of roof-dwelling opfor.<br/>
	ENDTAB;
};
...
case east: { //If player is west he receives this briefing
	...
	NEWTAB("Tactical Notes:")
	Osema Ban-Layden has skillfully setup an off <marker name='ramp'>ramp</marker> directly to the right of the bridge should we want to use it to get away.<br/>
	ENDTAB;
}; //end EAST

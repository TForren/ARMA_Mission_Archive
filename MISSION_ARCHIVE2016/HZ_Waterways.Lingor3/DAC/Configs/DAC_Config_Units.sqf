...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ['CUP_I_GUE_Pilot','CUP_I_GUE_Crew','CUP_I_GUE_Officer', 'CUP_I_GUE_Ammobearer', 'CUP_I_GUE_Soldier_AR', 'CUP_I_GUE_Soldier_GL', 'CUP_I_GUE_Sniper', 'CUP_I_GUE_Engineer', 'CUP_I_GUE_Soldier_MG', 'CUP_I_GUE_Medic', 'CUP_I_GUE_Soldier_AKS74', 'CUP_I_GUE_Soldier_AKM', 'CUP_I_GUE_Soldier_AKSU', 
	'CUP_I_GUE_Soldier_AT', 'CUP_I_GUE_Soldier_AT', 'CUP_I_GUE_Soldier_AA', 'CUP_I_GUE_Soldier_AA2', 'CUP_I_GUE_Saboteur'];
    _Unit_Pool_V = ['CUP_I_Datsun_PK_TK','CUP_I_Datsun_PK_TK_Random', 'CUP_I_Datsun_PK_TK_Random', 'CUP_I_BMP1_TK_GUE', 'rhs_bmd1_chdkz', 'rhs_bmp1_chdkz', 'CUP_O_UAZ_AGS30_CHDKZ', 'CUP_O_UAZ_SPG9_CHDKZ', 'CUP_I_T34_TK_GUE', 'rhs_uaz_open_chdkz'];
    _Unit_Pool_T = ['CUP_I_BMP1_TK_GUE', 'rhs_bmd1_chdkz', 'rhs_bmp1_chdkz', 'CUP_I_T34_TK_GUE'];
    _Unit_Pool_A = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
  };
//-------------------------------------------------------------------------------------------------

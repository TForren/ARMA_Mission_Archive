...
//Primary
#define B_rifle "CUP_arifle_Mk17_CQC"
#define B_ar "rhs_weap_m249_pip_S_vfg"
#define B_glrifle "CUP_arifle_Mk17_CQC_EGLM"
...
#define B_rco "rhsusf_acc_SpecterDR_A"
...
#define B_m4mb "CUP_muzzle_snds_SCAR_H"

//Ammo
#define B_riflemag "CUP_20Rnd_762x51_B_SCAR"
#define B_riflemag_tr "CUP_20Rnd_TE1_Red_Tracer_762x51_SCAR"

#define B_IARmag "rhs_mag_30Rnd_556x45_M855A1_Stanag"
#define B_IARmag_tr "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red"
...
#define B_vest_light "rhsusf_spcs_ocp_rifleman"
#define B_vest_iar "rhsusf_spcs_ocp_rifleman"
...
case "B_IAR": {
	...
	//Vest
	[B_IARmag,12,"vest"] call FNC_AddItem;
	[B_IARmag_tr,4,"vest"] call FNC_AddItem;
	...
	//Extra Mag
	[B_IARmag,1,"uniform"] call FNC_AddItem;
};
...
case "B_AIAR": {
	...
	//Vest
	[B_riflema,5,"vest"] call FNC_AddItem;
	[B_IARmag,5,"vest"] call FNC_AddItem;
	[B_IARmag_tr,2,"vest"] call FNC_AddItem;
	[B_riflemag_tr,2,"vest"] call FNC_AddItem;

...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ['CUP_O_INS_Crew','CUP_O_INS_Pilot','CUP_O_INS_Officer', 'CUP_O_INS_Soldier','CUP_O_INS_Soldier_Ammo', 'CUP_O_INS_Sniper', 'CUP_O_INS_Soldier_AT', 'CUP_O_INS_Soldier_Engineer', 'CUP_O_INS_Soldier_GL', 'CUP_O_INS_Soldier_MG', 'CUP_O_INS_Soldier_MG', 'CUP_O_INS_Medic', 'CUP_O_INS_Saboteur', 'CUP_O_INS_Soldier_AR', 'CUP_O_INS_Soldier', 'CUP_O_INS_Soldier_AK74', 'CUP_O_INS_Soldier_Exp'];
    _Unit_Pool_V = ['CUP_O_Ural_ZU23_CHDKZ', 'CUP_O_UAZ_MG_CHDKZ', 'CUP_O_UAZ_SPG9_CHDKZ', 'CUP_O_Datsun_PK_Random', 'CUP_I_BTR40_MG_TKG', 'rhs_btr60_chdkz'];
	_Unit_Pool_T = ["CUP_O_T72_CHDKZ",'rhs_bmp1_chdkz', 'rhs_bmp1k_chdkz', 'rhs_bmp1p_chdkz'];
...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ['CUP_O_INS_Villager3','CUP_O_INS_Villager3','CUP_O_INS_Villager3','CUP_O_INS_Villager3', 'CUP_O_INS_Woodlander3', 'CUP_O_INS_Woodlander2', 'CUP_O_INS_Worker2', 'CUP_O_INS_Villager4', 'CUP_O_INS_Woodlander1'];
    _Unit_Pool_V = ['CUP_C_Skoda_Blue_CIV', 'CUP_C_Skoda_Green_CIV', 'CUP_C_Skoda_Red_CIV', 'CUP_C_Skoda_White_CIV', 'CUP_C_Datsun_Covered', 'CUP_C_Golf4_black_Civ', 'CUP_C_Golf4_random_Civ', 'CUP_C_Datsun_4seat'];
...
// Independent (A3)
  case 2:
  {
	...
	'CUP_I_TK_GUE_Soldier_HAT','CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Guerilla_Enfield', 'CUP_I_TK_GUE_Soldier_GL', 'CUP_I_TK_GUE_Soldier_M16A2', 'CUP_I_TK_GUE_Soldier_AAT', 'CUP_I_TK_GUE_Sniper', 'CUP_I_TK_GUE_Mechanic', 'CUP_I_TK_GUE_Soldier_MG'];

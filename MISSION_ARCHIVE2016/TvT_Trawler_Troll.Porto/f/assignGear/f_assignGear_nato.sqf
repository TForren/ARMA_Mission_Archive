...
_scope6 = "rhsusf_acc_ELCAN";			//Elcan for M240
...
// Backpacks
_bagsmall = "ffaa_brilat_mochila_arida_municion";		
_bagmedium = "ffaa_brilat_mochila_arida_municion";
...
_baseUniform = ["ffaa_brilat_CombatUniform_item_d"];
_baseHelmet = ["ffaa_moe_casco_01_2_b", "ffaa_moe_casco_01_2_d"];
_baseGlasses = ["TRYK_Shemagh_EAR_TAN", "TRYK_Shemagh"];

// Armored vests
_rigBasic = ["ffaa_et_moe_peco_02_d"];
_rigGrenadier = ["ffaa_et_moe_peco_02_d"];
_rigMedic = ["ffaa_et_moe_peco_02_d"];
_rigEngineer = ["ffaa_et_moe_peco_01_d"];
_rigRifleman = ["ffaa_et_moe_peco_02_d"];
_rigAutoRifleman = ["ffaa_et_moe_peco_02_d"];
_rigSquadLeader = ["ffaa_et_moe_peco_01_d"];
_rigTeamLeader = ["ffaa_et_moe_peco_01_d"];
...
// Pilot
_pilotUniform = ["ffaa_brilat_CombatUniform_item_d"];
_pilotHelmet = ["ffaa_casco_hercules_piloto"];
_pilotRig = [];
_pilotGlasses = ["TRYK_Shemagh_ESS"];
...
// LOADOUT: DESIGNATED MARKSMEN
	case "dm":
	{
		...
		_unit addmagazines [_smokegrenade,2];
		["dm"] call _backpack;
		_attachments = [_attach2, _M14Scope];
	};
...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addMagazineCargoGlobal [_handFlareRed, 4];
		_unit addMagazineCargoGlobal [_glFlareWhite, 8];

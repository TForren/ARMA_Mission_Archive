...
if (isServer) then { //This scope is only for the server
	...
	[west, "Police", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Insurgents", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east

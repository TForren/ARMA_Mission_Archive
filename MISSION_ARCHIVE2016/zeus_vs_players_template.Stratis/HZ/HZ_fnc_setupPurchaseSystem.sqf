_groups = [
//Name, ID, Cost, uses 
["Ural Motorized Infantry","MotorInf", 70, 3],
["BTR80 Mechanized Infantry","BTR80Mech", 200, 3],
["BTR80A Mechanized Infantry","BTR80AMech", 280, 3]
];

_veh = [
//Name, ID, Cost, uses 
["GAZ Tigr","GAZArmed", 10, 4],
["UAZ","UAZ", 2, 6],
["BMP-2K","BMP2K", 200, 2],
["ZSU-23","ZSU23", 180, 2],
["T-80A","T80A", 250, 1],
...
_inf = [
//Name, ID, Cost, uses 
["Infantry (Marksman)","INFMARK", 50, 3],
["Infantry (GPMG)","INFGPMG", 50, 3],
["Section Fire Team","INF_FT", 25, 3],
["Section AA","INF_AA", 25, 2],
["Section AT","INF_AT", 25, 2]
];

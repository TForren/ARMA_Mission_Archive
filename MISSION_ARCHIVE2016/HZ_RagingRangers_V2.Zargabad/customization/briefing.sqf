...
case west: { //If player is west he receives this briefing
	...
	<br/><br/>
	This weapon, containing aspartic acid histidine, phylloquinone, and Arginine has been left unattended in the abandoned building in the city of Zargabad marked P0745-51M.
	<br/><br/>

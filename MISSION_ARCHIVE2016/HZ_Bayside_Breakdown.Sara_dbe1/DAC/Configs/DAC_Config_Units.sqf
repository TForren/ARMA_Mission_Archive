...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["CUP_O_sla_Pilot","CUP_O_sla_Crew", "CUP_O_sla_Soldier_SL",'CUP_O_sla_Soldier_AA', 'CUP_O_sla_Soldier_AAT', 'CUP_O_sla_Soldier_AMG', 'CUP_O_sla_Soldier_AR', 'CUP_O_sla_Engineer', 'CUP_O_sla_Soldier_GL', 'CUP_O_sla_Soldier_MG', 'CUP_O_sla_Medic', 'CUP_O_sla_Soldier', 'CUP_O_SLA_Soldier_Backpack', 'CUP_O_sla_Soldier_LAT', 'CUP_O_sla_Soldier_AT', 'CUP_O_sla_Sniper'];
    _Unit_Pool_V = ['rhs_btr60_chdkz', 'rhs_btr70_chdkz', 'CUP_O_UAZ_MG_SLA', 'CUP_O_BRDM2_SLA'];
	_Unit_Pool_T = ["rhs_t72ba_tv","CUP_O_T34_TKA"];

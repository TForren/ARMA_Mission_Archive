...
NEWTAB("Tactical Notes:") //This is shown for everyone
<br/>Assaulting the beach with MH-80s is ill advised due to the beach AA.
<br/>
<br/>SPECTRE should begin their mission while the IFF wasp platoon plans and organizes.
<br/>
<br/>Both the AV-8B and AH-1Z should have JTAC laser lock capability and should engage targets out of visual range to avoid AA if not already destroyed.
ENDTAB;
...
<br/>
<br/>SPECTRE team must refer to each other by their TANGO-# designation (in a deep raspy voice) during operation or run the risk of their identify and personal safety being threatened.
<br/>

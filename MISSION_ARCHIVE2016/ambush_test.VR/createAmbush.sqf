...
_PossibleUnits = ['rhs_msv_emr_rifleman', 'rhs_msv_arifleman', 'rhs_msv_emr_machinegunner_assistant', 'rhs_msv_strelok_rpg_assist', 'rhs_msv_emr_efreitor', 'rhs_msv_arifleman'];

...
#define B_chemred "Chemlight_red"
...
//Headgear
#define B_leader_headgear "rhsusf_opscore_coy_cover_pelt"
#define B_default_headgear "rhsusf_opscore_coy_cover"
...
#define B_glasses "PU_shemagh_TanCLR"
...
case "B_PC": {
	...
	//Attachments
	[B_rifle_scope] call FNC_AddItem;["rhsusf_ANPVS_15"] call FNC_AddItem;
...
case "B_FTL": {
	...
	[B_glstun,2,"vest"] call FNC_AddItem;
	[B_shortrange,1,"vest"] call FNC_AddItem;
...
case "PIL": {
	...
	[B_chemred,2,"vest"] call FNC_AddItem;
	[B_strobe,1,"vest"] call FNC_AddItem;
	[B_ace_cabletie,2,"vest"] call FNC_AddItem;
	[B_shortrange,1,"vest"] call FNC_AddItem; 
	[B_longrange,1,"vest"] call FNC_AddItem;

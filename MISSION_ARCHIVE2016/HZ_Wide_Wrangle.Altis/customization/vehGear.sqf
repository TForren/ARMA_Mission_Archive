...
switch (_type) do {
	...
	case "STANDARD": {
		...
		["rhs_mag_30Rnd_556x45_M855A1_Stanag", 15] call FNC_AddItemVehicle;
		["rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", 15] call FNC_AddItemVehicle;
		["rhsusf_200Rnd_556x45_soft_pouch", 5] call FNC_AddItemVehicle;
		["rhsusf_100Rnd_762x51_m80a1epr", 5] call FNC_AddItemVehicle;
		...
		["rhsusf_acc_LEUPOLDMK4_2", 1] call FNC_AddItemVehicle;
		["rhsusf_acc_harris_bipod", 1] call FNC_AddItemVehicle;
		["rhsusf_5Rnd_762x51_m118_special_Mag", 4] call FNC_AddItemVehicle;
		["rhs_weap_m24sws", 1] call FNC_AddItemVehicle;

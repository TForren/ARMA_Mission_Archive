...
if (isServer) then { //This scope is only for the server
	...
	[west, "BAF ARSENIC 2", "player"] call FNC_AddTeam; //Adds a player team called USMC on side west
	[independent, "Sons of Cypriot", "ai"] call FNC_AddTeam; //Adds a ai team called VDV on side east

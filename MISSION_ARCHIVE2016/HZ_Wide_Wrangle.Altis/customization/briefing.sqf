...
<br/><br/>
Strength:<br/>
Expected light flank security including static weapons, foot patrols, MSV scout vehicles (BRDMS).<br/><br/>
...
e. Assets:<br/>
4x LAV-25<br/>
1x Javalin per LAV<br/>
1x M24 scout rifle per LAV<br/>
<br/>
ENDTAB;
...
<br/>
<br/>
e. Coordinating Instructions<br/><br/>
i) Timings:<br/>

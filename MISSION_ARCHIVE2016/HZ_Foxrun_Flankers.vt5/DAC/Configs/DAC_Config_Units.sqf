...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ['rhs_vdv_flora_crew', 'rhs_vdv_flora_crew', 'rhs_msv_emr_efreitor', 'rhs_msv_emr_grenadier_rpg', 'rhs_msv_emr_strelok_rpg_assist', 'rhs_msv_emr_machinegunner', 'rhs_msv_emr_marksman', 'rhs_msv_emr_rifleman', 'rhs_msv_emr_LAT', 'rhs_msv_emr_sergeant', 'rhs_msv_emr_rifleman', 'rhs_msv_emr_rifleman', 'rhs_msv_emr_rifleman'];
    _Unit_Pool_V = ['rhs_btr70_msv', 'rhs_btr80_msv', 'rhs_btr80a_msv', 'rhs_tigr_sts_3camo_msv', 'rhs_tigr_sts_msv', "RHS_Ural_MSV_01", "RHS_Ural_MSV_01"];
	_Unit_Pool_T = ['rhs_bmp2_msv', 'rhs_bmp2d_msv', 'rhs_bmp2k_msv', 'rhs_bmp2e_msv'];
	_Unit_Pool_A = ["RHS_Mi24P_CAS_vdv","RHS_Mi24P_vdv","RHS_Mi8MTV3_UPK23_vdv","RHS_Mi8MTV3_vdv","RHS_Mi8MTV3_FAB_vdv","RHS_Mi8MTV3_UPK23_vdv","RHS_Mi8MTV3_vdv","RHS_Mi8MTV3_FAB_vdv"];
  };
//-------------------------------------------------------------------------------------------------
// another indfor (A3)
  case 1:

...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		_campBasic     = ["Vysilacka",["CUP_RUSpecialWeaponsBox",0,6,0],["CUP_RUOrdnanceBox",6,0,90],["Logic",10,15,0],0];
		_campAmmo      = [];
		_campStatic    = [["rhs_2b14_82mm_msv", -7, 20, 0, "rhs_vdv_flora_engineer"]]; //["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]  "rhs_2b14_82mm_msv"
		_campAddUnit   = ["rhs_vdv_flora_engineer","rhs_vdv_flora_engineer"];
		_campUserObj   = [];
		_campRandomObj = [];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];
...
/*	case 3:
	{
		...
		_campRandomObj = [[["Land_TentA_F",0,50],["Land_WoodenBox_F",0,20],

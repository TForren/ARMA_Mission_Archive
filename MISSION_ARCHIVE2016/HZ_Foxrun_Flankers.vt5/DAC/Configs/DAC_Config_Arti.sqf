...
//-------------------------------------------------------------------------------------------------------------------------
	...
	{		//""
		_set0  = [20,2,0,60];
		_set1  = [2,0.1,10,[],3,30];
		_set2  = [75,200,50,500,4,3,1]; //HelicopterExploBig M_Scalpel_AT  rhs_2b14_82mm_msv    HelicopterExploBig
		_set3  = [["rhs_2b14_82mm_msv",["HelicopterExploSmall"]],["LOP_UA_BM21",["HelicopterExploBig"]]];
		_set4  = [10,20,1];
		_set5  = [10,80,1];
		_set6  = [10,80,1];
		_set7  = [0.1,0.5,0];
...
//-------------------------------------------------------------------------------------------------------------------------
	case 2:
	{
		...
		_set3  = [["rhs_2b14_82mm_msv",["M_PG_AT"]],["LOP_UA_BM21",["M_Mo_120mm_AT"]]];
		_set4  = [10,20,1];
		_set5  = [10,80,1];
		_set6  = [10,80,1];
		_set7  = [0.1,0.5,0];

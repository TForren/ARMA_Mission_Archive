	...
	class Controls
	{
		...
		class CSSA3_minmaxUnitListGroup: RscControlsGroup
		{
			...
			class controls
			{
				class CSSA3_minmaxUnitslistButton: RscCSSA3Button
				{
					...
					w = 0.0123125 * safezoneW;
					h = 0.03 * safezoneH;
					action = "[] execVM 'core\CSSA3\functions\fn_animateUnitList.sqf'";
				};
				class CSSA3_unitsFrame: RscFrame2
				{
					idc = 791202;
					text = "";
					x = -0.001;
		...
		class CSSA3_bottomBar: RscControlsGroup
		{
			...
			class controls
			{
				...
				class CSSA3_barBorder: RscFrame2
				{
					idc = 79132;
					x = 0 * safezoneW;
					y = 0.0003 * safezoneH;
				...
				class CSSA3_respawnMenuButton: RscCSSA3Button
				{
					idc = 79999;
					text = "Respawn as Civ"; 
					x = 0.045 * safezoneW;
					...
					w = 0.15 * safezoneW;
					h = 0.022 * safezoneH;
					tooltip = "Respawn as a Civilian, only one life.";
					action = " [] execVM 'respawn.sqf' ";
				};
		...
		class CSSA3_settingsControl: RscControlsGroup
		{
			...
			class controls
			{
				...
				class CSSA3_settingsFrame: RscFrame2
				{
					idc = 79141;
					x = 0.00020 * safezoneW;
					y = 0.0004 * safezoneH;
				...
				class CSSA3_viewdistanceText: RscText2
				{
					idc = 791451;
				...
				class CSSA3_unitNamesCbText: RscText2
				{
					idc = -1;
				...
				class CSSA3_unitTagsCbText: RscText2
				{
					idc = -1;
				...
				class CSSA3_clickToInteractCbText: RscText2
				{
					idc = -1;
				...
				class CSSA3_preloadCameraCbText: RscText2
				{
					idc = -1;
				...
				class CSSA3_btnCloseSettings: RscButton3
				{
					idc = 79148;
		...
		class CSSA3_interactMenuGroup: RscControlsGroup
		{
			...
			class controls
			{
				class CSSA3_InteractImage: RscPicture2
				{
					idc = 791511;
					text = "core\CSSA3\images\roseMid.paa";
				...
				class CSSA3_button1st: RscButton3
				{
					idc = 79153;
				...
				class CSSA3_buttonFree: RscButton3
				{
					idc = 79152;
				...
				class CSSA3_button3rd: RscButton3
				{
					idc = 79154;
				...
				class CSSA3_buttonRoseAddFavourite: RscButton3
				{
					idc = 79155;

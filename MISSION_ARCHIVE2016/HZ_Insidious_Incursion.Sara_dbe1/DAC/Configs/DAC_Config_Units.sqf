...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ['CUP_I_RACS_Pilot','CUP_I_RACS_Crew','CUP_I_RACS_SL', 'CUP_I_RACS_Sniper', 'CUP_I_RACS_Soldier', 'CUP_I_RACS_Medic', 'CUP_I_RACS_MMG', 'CUP_I_RACS_GL', 'CUP_I_RACS_Soldier_MAT', 'CUP_I_RACS_Engineer'];
    _Unit_Pool_V = ['CUP_I_LR_MG_RACS','CUP_I_M113_RACS'];
    _Unit_Pool_T = ['CUP_I_M113_RACS','CUP_I_M113_RACS','CUP_I_M113_RACS','CUP_I_M113_RACS','CUP_I_M113_RACS','CUP_I_T72_RACS'];
    _Unit_Pool_A = ['CUP_I_AH6J_Escort19_RACS', 'CUP_I_AH6J_Escort_RACS', 'CUP_I_UH60L_FFV_RACS','CUP_I_UH60L_RACS',"CUP_I_AH6J_MP_RACS"];
  };
//-------------------------------------------------------------------------------------------------
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ['CUP_I_TK_GUE_Soldier','CUP_I_TK_GUE_Soldier','CUP_I_TK_GUE_Soldier_TL', 'CUP_I_TK_GUE_Soldier','CUP_I_TK_GUE_Soldier', 'CUP_I_TK_GUE_Soldier_AR', 'CUP_I_TK_GUE_Guerilla_Medic', 'CUP_I_TK_GUE_Demo', 'CUP_I_TK_GUE_Soldier_AK_47S',
	'CUP_I_TK_GUE_Soldier_HAT','CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Guerilla_Enfield', 'CUP_I_TK_GUE_Soldier_GL', 'CUP_I_TK_GUE_Soldier_M16A2', 'CUP_I_TK_GUE_Soldier_AAT', 'CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Sniper', 'CUP_I_TK_GUE_Mechanic', 'CUP_I_TK_GUE_Soldier_MG'];

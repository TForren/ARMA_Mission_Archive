...
// EAST CSAT FACTION
	if (_faction==0) then {
	_InfPool=	["O_Soldier_SL_F","O_Soldier_TL_F","O_Soldier_AR_F","O_Soldier_AAR_F","O_medic_F","O_Soldier_LAT_F","O_Soldier_F","O_Soldier_GL_F"];
...
// INDEPENDENT AAF FACTION	
	if (_faction==2) then {
	_InfPool=	["I_Soldier_SL_F","I_Soldier_TL_F","I_Soldier_AR_F","I_Soldier_AAR_F","I_Soldier_LAT_F","I_medic_F","I_Soldier_A_F","I_Soldier_GL_F"];
...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["CAF_AG_ME_T_AK47","CAF_AG_ME_T_GL","CAF_AG_ME_T_PKM","CAF_AG_ME_T_PKM"];	
	_ArmPool=	[];
	_MotPool=	["CAF_AG_ME_T_Offroad_armed_01","CAF_AG_ME_T_Offroad_armed_01","CAF_AG_ME_T_Offroad_armed_01"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	[];

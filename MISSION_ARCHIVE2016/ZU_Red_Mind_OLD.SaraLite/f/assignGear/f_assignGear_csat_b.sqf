...
case "dc":
{
		...
		(unitBackpack _unit) addItemCargoGlobal [_glSmokeGreen, 4];
		(unitBackpack _unit) addItemCargoGlobal [_glSmokeWhite, 6];
};
...
case "ftl":
{
		...
		(unitBackpack _unit) addItemCargoGlobal [_glSmokeRed, 3];
		(unitBackpack _unit) addItemCargoGlobal [_glSmokeGreen, 3];
		(unitBackpack _unit) addItemCargoGlobal [_glSmokeWhite, 4];
};

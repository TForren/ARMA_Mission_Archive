...
if (isServer) then { //This scope is only for the server
	...
	[east, "USSR", "player"] call FNC_AddTeam; //Adds a player team called USMC on side west
	[independent, "Khalis Faction", "ai"] call FNC_AddTeam; //Adds a ai team called VDV on side east

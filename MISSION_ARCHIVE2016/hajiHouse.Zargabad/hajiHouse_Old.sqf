...
private _house = nearestBuilding (getpos (_params select 0));
...
_PossibleUnits = ["CUP_I_TK_GUE_Soldier", "CUP_I_TK_GUE_Soldier_AK_47S"];
...

{
	...
	_newDuder addEventHandler ["Hit", {
		[_this select 0] spawn HZ_fnc_rallySquad;

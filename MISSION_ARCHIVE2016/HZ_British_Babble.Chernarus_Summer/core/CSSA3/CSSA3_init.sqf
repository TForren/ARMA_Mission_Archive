...
if (hasInterface) then
{
	...
	//Compile functions
	CSSA3_fnc_classExists = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_classExists.sqf");
	CSSA3_fnc_draw3DHUD = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_draw3DHUD.sqf");
	CSSA3_fnc_mainSpectateFunctions = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_CSSA3_MainFunctions.sqf");
	CSSA3_fnc_createSpectateDialog = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_createSpectateDialog.sqf");
	CSSA3_fnc_mainUpdateLoop = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_mainUpdateLoop.sqf");
	CSSA3_fnc_forceReopen = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_forceReopen.sqf");
	CSSA3_fnc_unitListIndexChange = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_unitListIndexChanged.sqf");
	CSSA3_fnc_updateUnitList = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_updateUnitList.sqf");
	CSSA3_fnc_settingsHandler = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_settingsHandler.sqf");
	CSSA3_fnc_camMove = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_camMove.sqf");
	CSSA3_fnc_camRotate = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_camRotate.sqf");
	CSSA3_fnc_LMBhandler = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_LMBhandler.sqf");
	CSSA3_fnc_changeView = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_changeView.sqf");
	CSSA3_fnc_ctrlActive = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_ctrlActive.sqf");
	CSSA3_fnc_closeInteractRose = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_closeInteractRose.sqf");
	CSSA3_fnc_addremoveFavourite = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_addremoveFavourite.sqf");
	CSSA3_fnc_strToUnit = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_strToUnit.sqf");
	CSSA3_fnc_findInNested = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_findInNested.sqf");
	CSSA3_fnc_forceExit = compile preprocessFileLineNumbers ("core\CSSA3\functions\fn_forceExit.sqf");

...
case west: { //If player is west he receives this briefing
	...
	NEWTAB("I. Situation:")
	The Chernarussian Movement of the Red Star (ChDKZ) are a communist revolutionary organization based in Chernarus.<br/>
	The ChDKZ goal is the reestablishment of a communist government throughout the Republic of Chernarus, effectively returning the country back to old Soviet times.
	<br/>
	<br/>
	Recently, the ChDKZ have supiciously begun consolidating their forces in the <marker name='area'>forests around Black Lake</marker> for unknown reasons. 
	...
	<br/>
	<br/>
	The civilian opinion of the local British Forces in <marker name='HQ'>FOB IRON HILL</marker> is split. Some are in favor of the BLUFOR occupation and others are Pro-ChDKZ and may take up arms.
	ENDTAB;
	...
	<br/>
	Location:<br/>
	Scattered ChDKZ Encampments in and around the <marker name='area'>Black Lake forests</marker>. ChDKZ officers will most likely be around the encampments and/or supply caches.<br/>
	<br/>
	MLCOA:<br/>
	...
	a. Disposition:<br/>
	1PLT at <marker name='HQ'>FOB IRON HILL</marker>.<br/>
	<br/>
	...
	1x AW159 Wildcat pilot and co-pilot. <br/>
	1x AW101 Merlin pilot and co-pilot. <br/>
	<br/>
	f. Assets: <br/>
	...
	NEWTAB("II. Mission:")
	1PLT is to LOCATE and ELIMINATE 3x high-ranking ChDKZ officials leading the consolidation somewhere in the <marker name='area'>forests around Black Lake</marker>.
	<br/>
	ENDTAB;

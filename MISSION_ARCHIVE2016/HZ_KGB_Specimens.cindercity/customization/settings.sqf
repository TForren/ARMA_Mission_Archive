...
if (isServer) then { //This scope is only for the server
	...
	[east, "MSV", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[independent, "Specimen", "player"] call FNC_AddTeam; //Adds a ai team called MSV on side east

...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["CUP_O_TK_INS_Mechanic","CUP_O_TK_INS_Mechanic", "CUP_O_TK_INS_Soldier_TL", "CUP_O_TK_INS_Soldier", 'CUP_O_TK_INS_Soldier_AR', 'CUP_O_TK_INS_Soldier_MG', 'CUP_O_TK_INS_Guerilla_Medic', 'CUP_O_TK_INS_Bomber', 'CUP_O_TK_INS_Mechanic', 'CUP_O_TK_INS_Soldier', 'CUP_O_TK_INS_Soldier_FNFAL', 'CUP_O_TK_INS_Soldier_Enfield', 'CUP_O_TK_INS_Soldier_GL', 'CUP_O_TK_INS_Soldier_GL', 'CUP_O_TK_INS_Soldier', 'CUP_O_TK_INS_Soldier_FNFAL', 'CUP_O_TK_INS_Soldier_Enfield', 'CUP_O_TK_INS_Soldier_AAT', 'CUP_O_TK_INS_Soldier_AT', 'CUP_O_TK_INS_Sniper'];
    _Unit_Pool_V = ['CUP_O_BTR40_MG_TKM', 'CUP_O_LR_MG_TKM', 'CUP_O_UAZ_MG_TKA', 'CUP_I_Datsun_PK_TK_Random', 'CUP_I_Datsun_PK_TK',"CUP_C_Datsun_4seat","CUP_C_Datsun_4seat","CUP_C_Datsun_4seat"];
	_Unit_Pool_T = ["CUP_O_BTR40_MG_TKM","CUP_O_Ural_ZU23_TKM"];
...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ['CUP_I_TK_GUE_Soldier_TL', 'CUP_I_TK_GUE_Soldier','CUP_I_TK_GUE_Soldier', 'CUP_I_TK_GUE_Soldier_AR', 'CUP_I_TK_GUE_Guerilla_Medic', 'CUP_I_TK_GUE_Demo', 'CUP_I_TK_GUE_Soldier_AK_47S','CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Guerilla_Enfield', 'CUP_I_TK_GUE_Soldier_GL', 'CUP_I_TK_GUE_Soldier_M16A2', 'CUP_I_TK_GUE_Soldier_AAT', 'CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Sniper', 'CUP_I_TK_GUE_Mechanic', 'CUP_I_TK_GUE_Soldier_MG'];
    _Unit_Pool_V = ['CUP_I_Datsun_PK_TK', 'CUP_I_Datsun_PK_TK_Random', 'CUP_I_Datsun_PK_TK_Random', 'CUP_I_BMP1_TK_GUE', 'CUP_O_UAZ_AGS30_CHDKZ', 'CUP_O_UAZ_SPG9_CHDKZ','CUP_I_BTR40_MG_TKG'];
    _Unit_Pool_T = ['CUP_I_Datsun_PK_TK', 'CUP_I_BTR40_MG_TKG', 'CUP_I_BTR40_MG_TKG', 'CUP_I_BMP1_TK_GUE', 'CUP_I_T34_TK_GUE'];

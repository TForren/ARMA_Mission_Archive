...
if (isServer) then { //This scope is only for the server
	...
	[east, "VDV QRF OBOROTEN", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[independent, "Takistan Insurgents", "ai"] call FNC_AddTeam; //Adds a player team called USA on side west

...
private _nearbyBuildings = nearestTerrainObjects [_chosenHousePos, ["building","house"], [_areaX,_areaY] call BIS_fnc_greatestNum];

_PossibleUnits = ['CUP_I_TK_GUE_Soldier_TL', 'CUP_I_TK_GUE_Soldier','CUP_I_TK_GUE_Soldier', 'CUP_I_TK_GUE_Soldier_AR', 'CUP_I_TK_GUE_Guerilla_Medic', 'CUP_I_TK_GUE_Demo', 'CUP_I_TK_GUE_Soldier_AK_47S','CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Soldier_GL', 'CUP_I_TK_GUE_Soldier_M16A2', 'CUP_I_TK_GUE_Soldier_AAT', 'CUP_I_TK_GUE_Soldier_AT', 'CUP_I_TK_GUE_Sniper', 'CUP_I_TK_GUE_Mechanic', 'CUP_I_TK_GUE_Soldier_MG'];
...
HZ_fnc_execAmbush = {
	...
	{
	    if (side _x == independent) then { //getting all indfor in the ambush area
...
HZ_fnc_rallySquad = {
	...
	{
		_ambushGroup = createGroup independent;

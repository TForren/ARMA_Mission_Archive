...
if (isServer) then { //This scope is only for the server
	...
	FW_TimeLimit = 35; //Time limit in minutes, to disable the time limit set it to 0
	
	[west, "RCA", "player"] call FNC_AddTeam; //Adds a player team called USA on side west

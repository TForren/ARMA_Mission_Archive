...
if (isServer) then { //This scope is only for the server
	...
	[west, "PMC", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Pirates", "player"] call FNC_AddTeam; //Adds a ai team called MSV on side east

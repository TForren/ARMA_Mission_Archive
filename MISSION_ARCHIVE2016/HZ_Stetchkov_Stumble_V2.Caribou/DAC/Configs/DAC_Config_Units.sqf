...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["rhs_g_Soldier_SL_F", "rhs_g_Soldier_SL_F","rhs_g_Soldier_SL_F",'rhs_g_Soldier_TL_F', 'rhs_g_Soldier_AT_F', 'rhs_g_Soldier_lite_F', 'rhs_g_Soldier_F', 'rhs_g_Soldier_F2', 'rhs_g_Soldier_M_F', 'rhs_g_Soldier_LAT_F', 'rhs_g_Soldier_GL_F', 'rhs_g_Soldier_exp_F', 'rhs_g_Soldier_F3', 'rhs_g_medic_F', 'rhs_g_Soldier_AAR_F', 'rhs_g_Soldier_AR_F', 'rhs_g_Soldier_LAT_F', 'rhs_g_engineer_F', 'rhs_g_Soldier_AA_F'];
    _Unit_Pool_V = ['rhs_btr60_chdkz', 'rhs_btr70_chdkz', 'rhs_uaz_spg9_chdkz', 'rhs_uaz_dshkm_chdkz', 'rhs_uaz_ags_chdkz'];
    _Unit_Pool_T = ['rhs_bmd1_chdkz', 'rhs_bmp1_chdkz', 'rhs_bmp1k_chdkz', 'rhs_t72ba_tv'];

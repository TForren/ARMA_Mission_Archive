...
weatherTemplates = [
        ...
        ["Medium Fog",[0,2,5,6],[0.4,0,[0.2,0.01,10],0,0]], //["Medium Fog",[5,6,7],[0.4,0,[0.4,0.05,10],0,0]],
        ["Dense Fog",[0,2,5,6],[0.4,0,[0.2,0.01,10],0,0]] // ["Dense Fog",[6],[0.5,0,[0.4,0.0025,30],0,0]]
	];

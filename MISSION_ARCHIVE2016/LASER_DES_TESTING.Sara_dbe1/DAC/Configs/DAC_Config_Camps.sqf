...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		...
		_campAmmo      = [];
		_campStatic    = [["rhs_KORD_high_VDV",-7,20,0,"CUP_O_sla_Engineer"]]; //["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]
		_campAddUnit   = ["CUP_O_sla_Soldier_AR","CUP_O_sla_Soldier_GL"];

...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ["LOP_AM_Soldier_TL","LOP_AM_Soldier_SL", "LOP_AM_Soldier_SL", "LOP_AM_Soldier_Medic","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier","LOP_AM_Soldier_GL","LOP_AM_Soldier_AR","LOP_AM_Soldier_Marksman","LOP_ISTS_Infantry_Rifleman","LOP_ISTS_Infantry_AR","LOP_ISTS_Infantry_GL","LOP_ISTS_Infantry_Marksman"];
...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_AFR_Infantry_SL","LOP_AFR_Infantry_SL","LOP_AFR_Infantry_SL","LOP_AFR_Infantry_AT","LOP_AFR_Infantry_AT","LOP_AFR_Infantry_AT","LOP_AFR_Infantry_Corpsman", "LOP_AFR_Driver", "LOP_AFR_Infantry_GL","LOP_AFR_Infantry_IED","LOP_AFR_Infantry_AR","LOP_AFR_Infantry_Marksman","LOP_AFR_Infantry_Rifleman"];
    _Unit_Pool_V = ["I_mas_cars_LR_soft_SPG9","I_mas_cars_UAZ_SPG9"]; //rhs_ural_work_open_chdkz rhs_ural_open_chdkz
    _Unit_Pool_T = ["rhs_bmp1_tv","rhs_btr70_chdkz"];
    _Unit_Pool_A = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
  };
//-------------------------------------------------------------------------------------------------

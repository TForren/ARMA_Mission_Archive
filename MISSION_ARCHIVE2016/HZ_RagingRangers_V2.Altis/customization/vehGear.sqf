...
switch (_type) do {
	...
	case "STD2": {
		...
		["CUP_100Rnd_556x45_BetaCMag", 6] call FNC_AddItemVehicle;
		["CUP_20Rnd_762x51_B_M110", 6] call FNC_AddItemVehicle;
		["UK3CB_BAF_L128A1_Pellets", 6] call FNC_AddItemVehicle;
		["UK3CB_BAF_L128A1_Slugs", 6] call FNC_AddItemVehicle;
		["rhsusf_mag_17Rnd_9x19_JHP", 6] call FNC_AddItemVehicle;
		["rhsusf_mag_6Rnd_M433_HEDP", 8] call FNC_AddItemVehicle;
		["CUP_1Rnd_HE_M203", 20] call FNC_AddItemVehicle;
		["V_Press_F", 1] call FNC_AddItemVehicle;

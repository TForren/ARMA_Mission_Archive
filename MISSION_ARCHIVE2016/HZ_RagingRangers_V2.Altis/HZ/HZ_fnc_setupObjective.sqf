...
_spotOK = false;
_tries = 0;
_possibleTrigs = [objTrig1,objTrig2,objTrig3,objTrig4,objTrig5,objTrig6,objTrig7,objTrig8,objTrig9,objTrig10,objTrig11,objTrig12,objTrig13,objTrig14,objTrig15];

while {!_spotOK} do {
	_trig = _possibleTrigs call BIS_fnc_selectRandom;

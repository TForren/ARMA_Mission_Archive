...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_NAPA_Infantry_TL","LOP_NAPA_Infantry_SL","LOP_NAPA_Infantry_AT","LOP_NAPA_Infantry_AR", "LOP_NAPA_Infantry_Marksman","OP_NAPA_Infantry_Rifleman","LOP_NAPA_Infantry_Engineer","LOP_NAPA_Infantry_Corpsman"];

...
// Independent (A3)
  case 2:
  {
	...
	'rhs_g_Soldier_exp_F', 'rhs_g_Crew_F', 'rhs_g_engineer_F', 'rhs_g_Soldier_LAT_F', 'rhs_g_Soldier_AAT_F', 'rhs_g_Soldier_AR_F', 'rhs_g_Soldier_AAR_F', 'rhs_g_Soldier_M_F', 'rhs_g_medic_F', 'rhs_g_Soldier_F2', 'rhs_g_Soldier_F3', 'rhs_g_Soldier_F', 'rhs_g_Soldier_GL_F', 'rhs_g_Soldier_lite_F', 'rhs_g_Soldier_AT_F', 'rhs_g_Soldier_AT_F'];
    _Unit_Pool_V = ['CUP_O_Ural_ZU23_CHDKZ','CUP_I_Datsun_PK_TK','CUP_I_Datsun_PK_TK_Random', 'CUP_I_BMP1_TK_GUE', 'rhs_bmd1_chdkz', 'rhs_bmp1_chdkz', 'CUP_O_UAZ_AGS30_CHDKZ', 'CUP_O_UAZ_SPG9_CHDKZ', 'CUP_I_T34_TK_GUE'];
    _Unit_Pool_T = ['CUP_I_BMP1_TK_GUE', 'rhs_bmd1_chdkz', 'rhs_bmp1_chdkz', 'CUP_I_T34_TK_GUE','CUP_I_T55_TK_GUE','CUP_O_BMP2_ZU_TKA','CUP_O_Ural_ZU23_CHDKZ','CUP_O_BMP2_ZU_TKA'];
    _Unit_Pool_A = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
  };
//-------------------------------------------------------------------------------------------------
// Civilians (A3)

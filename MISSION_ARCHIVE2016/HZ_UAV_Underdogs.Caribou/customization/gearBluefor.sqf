...
//Primary
#define B_rifle "rhs_weap_m16a4_carryhandle_pmag"
...
//Headgear
#define B_leader_headgear "rhsusf_lwh_helmet_marpatwd_headset_blk"
...
//Platoon JTAC.
case "B_JTAC": {
	["rhsusf_bowman_cap"] call FNC_AddItem;
	[B_default_uniform] call FNC_AddItem;
	[B_vest_leader] call FNC_AddItem;
	[B_glasses] call FNC_AddItem;
	["CUP_B_UAVTerminal_Black"] call FNC_AddItem;
...
case "B_VG": {
	...
	[B_default_uniform] call FNC_AddItem;
	[B_vest_default] call FNC_AddItem;
	["G_Bandanna_oli"] call FNC_AddItemRandom;
...
case "B_VC": {
	...
	[B_flarered,1,"vest"] call FNC_AddItem; 
	[B_strobe,1,"vest"] call FNC_AddItem;
	["ItemGPS",1,"vest"] call FNC_AddItem;

...
_staticWeapons = ["rhs_KORD_high_MSV","rhs_KORD_high_MSV","rhs_KORD_high_MSV","rhs_Kornet_9M133_2_msv"]; //,"CUP_O_DSHKM_TK_INS"
_staticWeaponsLow = ["RHS_NSV_TriPod_MSV","RHS_AGS30_TriPod_MSV","rhs_KORD_MSV","RHS_NSV_TriPod_MSV","rhs_Metis_9k115_2_msv","rhs_SPG9M_MSV"];

_loadouts = ["O_MG","O_RIF","O_RIF","O_MARK"];
...
_trenchGroup = createGroup east;
	...
	_newDuder1 = _trenchGroup createUnit ["O_Soldier_F", _spawnPos, [], 0, "FORM"];
	...
	if (random 1 > 0.6) then {
		...
		[_newDuder3, "O_RIF"] call FNC_GearScript;

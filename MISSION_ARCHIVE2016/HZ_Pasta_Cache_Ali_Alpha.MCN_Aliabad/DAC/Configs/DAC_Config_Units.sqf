...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ['CUP_I_TK_GUE_Soldier_TL', 'CUP_I_TK_GUE_Soldier_TL','CUP_I_TK_GUE_Soldier_TL', 'CUP_I_TK_GUE_Soldier', 'CUP_I_TK_GUE_Soldier_AR', 'CUP_I_TK_GUE_Guerilla_Medic', 'CUP_I_TK_GUE_Demo', 'CUP_I_TK_GUE_Soldier_AK_47S',

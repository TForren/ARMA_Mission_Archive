...
case west: { //If player is west he receives this briefing
	...
	NEWTAB("I. Situation:")
	HQ has confirmed heavy insurgent activity at the designated town [<marker name='town'>LC030098</marker>] and have strong evidence of an insurgent weapons cache present in the town.
	<br/>
	<br/>
	...
	NEWTAB("II. Mission:")
	1PLT is to locate and DESTROY the insurgent weapons cache in town [<marker name='town'>LC030098</marker>].
	<br/>
	ENDTAB;
	...
	1PLT is to DESTROY the weapons cache in town [<marker name='town'>LC030098</marker>]<br/>
	<br/>

...
#define B_default_headgear "rhsusf_lwh_helmet_marpatd"
...
case "B_FTL": {
	...
	[B_glflare,2,"vest"] call FNC_AddItem;
...
case "B_SHOT": {
	...
	[B_default_uniform] call FNC_AddItem;
	["V_PlateCarrierSpec_mtp"] call FNC_AddItem;
	["rhs_ess_black"] call FNC_AddItem;
	
	//Uniform
	["UK3CB_BAF_L128A1_Slugs",3,"uniform"] call FNC_AddItem;
	...
	//Vest
	["UK3CB_BAF_L128A1_Pellets",8,"vest"] call FNC_AddItem;
	...
	//Attachments
	["CUP_optic_MRad"] call FNC_AddItem;

...
_trenchGroup = createGroup east;
	...
	_newDuder1 = _gunGroup createUnit ["CUP_O_TK_Soldier", _spawnPos, [], 0, "FORM"];
	...
	_newDuder2 = _trenchGroup createUnit ["CUP_O_TK_Soldier", _spawnPos, [], 0, "FORM"];
	_newDuder3 = _trenchGroup createUnit ["CUP_O_TK_Soldier", _spawnPos, [], 0, "FORM"];

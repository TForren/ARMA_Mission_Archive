...
_outpostVehicles = ["CUP_O_UAZ_MG_TKA","CUP_O_UAZ_Unarmed_TKA","CUP_O_LR_MG_TKA"];
...
for [{_i=0}, {_i<_outpostCount}, {_i=_i+1}] do
{
	...
	_newDuder1 = _outpostGroup createUnit ["CUP_O_TK_Soldier", _chosenPos, [], 0, "FORM"];
	_newDuder1 setpos (_newDuder1 modelToWorld [(random 10),(random 5),-1.5]);	
	_newDuder2 = _outpostGroup createUnit ["CUP_O_TK_Soldier", _chosenPos, [], 0, "FORM"];

["HC AI Transfer", "The script transfers units to any number of HCs.", "Werthles"] call FNC_RegisterModule;
...
[true,30,false,true,30,3,true,[]] execVM "modules\hc\WerthlesHeadless.sqf";
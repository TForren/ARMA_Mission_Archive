...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_AM_Soldier","LOP_AM_Soldier","LOP_AM_Soldier_SL","LOP_AM_Soldier_TL","LOP_AM_Soldier_Marksman","LOP_AM_Soldier_Engineer","LOP_AM_Soldier_GL","LOP_AM_Soldier_Medic","LOP_AM_Soldier_Medic","LOP_AM_Soldier_AT"];

...
//Sakhe [<marker name='town'>LC035042</marker>] 
...
case west: { //If player is west he receives this briefing
	...
	NEWTAB("I. Situation:")
	HQ has confirmed heavy insurgent activity at the town of Sakhe [<marker name='town'>LC035042</marker>]  and have strong evidence of an insurgent weapons cache present in the town.
	<br/>
	<br/>
	...
	<br/>
	Location:<br/>
	Sakhe [<marker name='town'>LC035042</marker>]  .<br/>
	<br/>
	MLCOA:<br/>
	...
	NEWTAB("II. Mission:")
	1PLT is to locate and DESTROY the insurgent weapons cache in Sakhe [<marker name='town'>LC035042</marker>]  .
	<br/>
	ENDTAB;
	...
	1PLT is to DESTROY the weapons cache in Sakhe [<marker name='town'>LC035042</marker>]  <br/>
	<br/>

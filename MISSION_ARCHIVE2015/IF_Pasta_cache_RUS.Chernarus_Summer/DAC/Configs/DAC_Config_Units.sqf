...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_NAPA_Soldier_TL","LOP_NAPA_Infantry_TL", "LOP_NAPA_Infantry_SL", "LOP_NAPA_Infantry_Marksman","LOP_NAPA_Infantry_Engineer","LOP_NAPA_Infantry_GL","LOP_NAPA_Infantry_AR","LOP_NAPA_Infantry_AT"];
    _Unit_Pool_V = ["LOP_NAPA_Landrover_M2","B_mas_cars_Hilux_MG","I_mas_cars_UAZ_MG","I_mas_cars_UAZ_SPG9"]; //rhs_ural_work_open_chdkz rhs_ural_open_chdkz
    _Unit_Pool_T = ["rhs_bmp1_tv","rhs_btr70_chdkz"];
    _Unit_Pool_A = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
  };
//-------------------------------------------------------------------------------------------------
// Civilians (A3)
  case 3:
  {
    _Unit_Pool_S = 	["RDS_Villager1", "RDS_Villager2", "RDS_Villager3", "RDS_Villager4"];

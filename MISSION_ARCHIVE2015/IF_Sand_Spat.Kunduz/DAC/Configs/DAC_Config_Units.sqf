...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["O_SoldierU_SL_F","O_soldierU_repair_F", "O_SoldierU_SL_F", "O_soldierU_medic_F","O_sniper_F","O_Soldier_A_F","O_Soldier_AA_F","O_Soldier_AAA_F","O_Soldier_AAR_F","O_Soldier_AAT_F","O_Soldier_AR_F","O_Soldier_AT_F","O_medic_F"];
...
// another indfor (A3)
  case 1:
  {
    _Unit_Pool_S = ["LOP_AM_Soldier_TL","LOP_AM_Soldier_SL", "LOP_AM_Soldier_Medic","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier_GL","LOP_AM_Soldier_AR","LOP_AM_Soldier_Marksman","LOP_ISTS_Infantry_AT","LOP_ISTS_Infantry_AR","LOP_ISTS_Infantry_GL","LOP_ISTS_Infantry_Marksman"];
...
// Independent (A3)
  case 2:
  {
    ...
    _Unit_Pool_V = ["LOP_AM_Landrover_M2","LOP_AM_Landrover_M2","LOP_AM_Landrover_M2","rhs_btr70_chdkz"]; //rhs_ural_work_open_chdkz rhs_ural_open_chdkz
    _Unit_Pool_T = ["rhs_bmp1_tv","rhs_btr70_chdkz"];
    _Unit_Pool_A = ["I_Heli_Transport_02_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F"];
  };
//-------------------------------------------------------------------------------------------------

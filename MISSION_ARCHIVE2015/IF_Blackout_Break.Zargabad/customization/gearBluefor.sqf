...
case "B_SL": {
	...
	["TRYK_V_Bulletproof",1, "backpack"] call FNC_AddItem;
...
#define PMC_goggles_r "TRYK_Shemagh_mesh", "TRYK_Shemagh", "RNR_Tac_smallBeardD", "EWK_Shemag_tan_Cig6"
...
case "PMC_GRE": {
	...
	[PMC_pistol_mag,4,"vest"] call FNC_AddItem; 
...
case "Police": {
	["RNR_KartuzHat_RedBlack"] call FNC_AddItemRandom;
	["rds_uniform_Policeman"] call FNC_AddItemRandom;
	["RNR_p2_ak_black"] call FNC_AddItemRandom;
	["EWK_Glasses_Cig6"] call FNC_AddItemRandom;
	...
	//Vest
	["hlc_30Rnd_545x39_B_AK",3,"vest"] call FNC_AddItem; 
	["RH_6Rnd_45ACP_Mag",1,"vest"] call FNC_AddItem; 
	["RH_6Rnd_45ACP_Mag",2,"backpack"] call FNC_AddItem; 
	
	//Backpack
	["hlc_30Rnd_545x39_B_AK",5,"backpack"] call FNC_AddItem;
...
case "PMC_VIP": {
	["rds_uniform_Functionary1"] call FNC_AddItem;
	["ACE_Banana",1,"uniform"] call FNC_AddItem;

};

case "bomber": {
	["TRYK_ZARATAKI", "TRYK_ZARATAKI2", "TRYK_ZARATAKI3"] call FNC_AddItemRandom;
	["rhs_vydra_3m"] call FNC_AddItem;
	["ACE_Banana",1,"uniform"] call FNC_AddItem;

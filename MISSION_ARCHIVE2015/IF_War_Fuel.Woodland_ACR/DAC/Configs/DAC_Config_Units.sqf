...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_UA_Soldier_Pilot", "LOP_UA_Soldier_TL","LOP_UA_Soldier_SL","LOP_UA_Soldier_Medic","LOP_UA_Soldier_AT","LOP_UA_Soldier_AT","LOP_UA_Soldier","LOP_UA_Soldier_GL","LOP_UA_Soldier_AR","LOP_UA_Soldier_Marksman"];
    _Unit_Pool_V = ["LOP_CDF_Landrover","LOP_US_BTR60","rhs_uaz_open_MSV_01","RHS_Ural_MSV_01","LOP_CDF_Landrover_M2"];
    _Unit_Pool_T = ["rhs_bmd1pk","rhs_bmd1"];

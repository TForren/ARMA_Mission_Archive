...
// Russians MSV
  case 0:
  {
    ...
    _Unit_Pool_V = ["rhs_btr60_vdv","rhs_btr70_vdv","rhs_btr80_vdv","rhs_btr80a_vdv","rhs_sprut_vdv","rhs_bmd1","rhs_bmd1k","rhs_bmd1p","rhs_bmd1pk", // APC/IFV/BMD/All
					"rhs_bmd1r","rhs_bmd2","rhs_bmd2k","rhs_bmd2m","rhs_bmd4_vdv","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_bmp1_vdv",
					"rhs_bmp1d_vdv","rhs_bmp1k_vdv","rhs_bmp1p_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv","rhs_bmp2k_vdv","rhs_brm1k_vdv","rhs_prp3_vdv"]; //Transports and BTR
    _Unit_Pool_T = ["rhs_bmp1_msv","rhs_bmp1d_msv","rhs_bmp1k_msv","rhs_bmp1p_msv","rhs_bmp2_msv","rhs_bmp2e_msv","rhs_bmp2d_msv","rhs_bmp2k_msv","rhs_t72ba_tv"]; //Armor
    _Unit_Pool_A = [];
  };
//-------------------------------------------------------------------------------------------------
// BLUFOR (A3)
...
// Independent (A3)
  case 2:
  {
    ...
    _Unit_Pool_V = ["I_Truck_02_covered_F","I_Truck_02_transport_F","I_Truck_02_medical_F","I_MRAP_03_hmg_F","I_MRAP_03_F"];
...
// Russian Artillery
  case 5:
  {
    _Unit_Pool_S = ["rhs_msv_crew","rhs_msv_driver","rhs_msv_driver"];
    _Unit_Pool_V = ["rhs_2s3_tv"];
	_Unit_Pool_T = [];
	_Unit_Pool_A = [];
  }; 

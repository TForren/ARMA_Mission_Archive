...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		_campBasic     = ["Land_MetalBarrel_F",["Land_WoodPile_F",0,6,0],["Land_TentA_F",6,0,90],["Logic",10,15,0],0];
		_campAmmo      = [];
		_campStatic    = [["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]]; //["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]
		_campAddUnit   = ["LOP_ChDKZ_Soldier_A_AT","LOP_ChDKZ_Soldier_AR"];

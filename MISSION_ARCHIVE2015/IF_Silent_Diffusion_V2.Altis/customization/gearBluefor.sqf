...
//=== Clothes ===
	...
	//Uniform              
#define B_default_uniform "TRYK_U_B_BLKBLK_CombatUniform"
...
case "B_TL": {
	...
	//Vest
	[B_smgmag,5,"vest"] call FNC_AddItem; 
	["ACE_HuntIR_M203",5,"vest"] call FNC_AddItem; 
	["ACE_HuntIR_monitor",1,"vest"] call FNC_AddItem; 
...
case "B_DIV": {
	...
	//Uniform
	["RH_20Rnd_57x28_FN",2,"uniform"] call FNC_AddItem;
	
	B_ace_default;
	["ACE_M84",2,"uniform"] call FNC_AddItem;
	
	//Vest
	["RH_20Rnd_57x28_FN",4,"uniform"] call FNC_AddItem; 
	...
	//Weapons
	["RH_fn57"] call FNC_AddItem;
	[B_range] call FNC_AddItem;
	
	//Attachments
	["RH_X300"] call FNC_AddItem;
	["RH_sfn57"] call FNC_AddItem;
	["ACE_NVG_Wide"] call FNC_AddItem;
};

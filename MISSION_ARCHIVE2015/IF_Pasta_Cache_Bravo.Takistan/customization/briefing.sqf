...
//Garmsar [<marker name='town'>LC106063</marker>] 
...
case west: { //If player is west he receives this briefing
	...
	NEWTAB("I. Situation:")
	HQ has confirmed heavy insurgent activity at the town of Garmsar [<marker name='town'>LC106063</marker>] and have strong evidence of an insurgent weapons cache present in the town.
	<br/>
	<br/>
	...
	<br/>
	Location:<br/>
	Garmsar [<marker name='town'>LC106063</marker>] .<br/>
	<br/>
	MLCOA:<br/>
	...
	NEWTAB("II. Mission:")
	1PLT is to locate and DESTROY the insurgent weapons cache in Garmsar [<marker name='town'>LC106063</marker>] .
	<br/>
	ENDTAB;
	...
	1PLT is to DESTROY the weapons cache in Garmsar [<marker name='town'>LC106063</marker>] <br/>
	<br/>
...
NEWTAB("Being Afghan")
<br/>
It's a good day to be an Afghan civilian in Nagara. 
<br/>

...
//Primary
#define B_rifle "RHS_WEAP_MK18_GRIP2_KAC"
...
//=== Clothes ===
	...
	//Uniform              
#define B_default_uniform_r "TRYK_U_B_ACUTshirt", "TRYK_U_B_ACU"

//Headgear
#define B_leader_headgear_r "rhsusf_ach_helmet_ucp", "rhsusf_ach_helmet_ESS_ucp"
#define B_default_headgear_r "rhsusf_ach_helmet_ucp", "rhsusf_ach_helmet_ESS_ucp"
...
//Vests
#define B_vest_default "rhsusf_iotv_ucp_rifleman"
#define B_vest_grenadier "rhsusf_iotv_ucp_grenadier"
#define B_vest_saw "rhsusf_iotv_ucp_SAW"
#define B_vest_medic "rhsusf_iotv_ucp_medic"
...
#define B_vest_leader "rhsusf_iotv_ucp_squadleader"
#define B_vest_ftl_leader "rhsusf_iotv_ucp_teamleader"
...
case "B_AT": {
	...
	//Weapons
	[B_rifle] call FNC_AddItem;
	["tf47_m3maaws"] call FNC_AddItem;
	
	//Extra Mag
	[B_riflemag,1,"uniform"] call FNC_AddItem;
	["tf47_m3maaws_HEDP",2,"backpack"] call FNC_AddItem;
	["tf47_m3maaws_HE",1,"backpack"] call FNC_AddItem;
	
	//Attachments
	[B_rifle_scope] call FNC_AddItem;
	["tf47_optic_m3maaws"] call FNC_AddItem;
	[B_ir_laser] call FNC_AddItem;["ACE_NVG_Gen2"] call FNC_AddItem;
};
case "B_AAT": {
	[B_default_headgear_r] call FNC_AddItemRandom;
...
case "B_MT_LEAD": {
	...
	["TRYK_B_Coyotebackpack"] call FNC_AddItem;
	["UK3CB_BAF_G_Tactical_Black"] call FNC_AddItem;
	//Uniform
	B_ace_default;
...
case "B_PIL": {
	...
	[B_default_uniform_r] call FNC_AddItemRandom;
	["TRYK_Hrp_vest_ucp"] call FNC_AddItem;
	//Uniform
	B_ace_default;
	//
...
case "B_PIL2": {
	...
	//Vest
	["RH_15Rnd_9x19_M9",4,"vest"] call FNC_AddItem; 

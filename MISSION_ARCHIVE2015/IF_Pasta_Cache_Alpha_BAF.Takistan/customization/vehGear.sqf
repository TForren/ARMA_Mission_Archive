...
switch (_type) do {
	...
	case "STD2": {
		...
		["UK3CB_BAF_30Rnd", 10] call FNC_AddItemVehicle;
		["UK3CB_BAF_L85A2_RIS", 2] call FNC_AddItemVehicle;
	...
	case "STD": {
		...
		["UK3CB_BAF_30Rnd", 12] call FNC_AddItemVehicle;
		["UK3CB_BAF_L85A2_RIS", 2] call FNC_AddItemVehicle;
		["UK3CB_BAF_100Rnd", 5] call FNC_AddItemVehicle;
		
		["UK3CB_BAF_NLAW_Launcher", 1] call FNC_AddItemVehicle;

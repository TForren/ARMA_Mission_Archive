...
case west: { //If player is west he receives this briefing
	...
	NEWTAB("I. Situation:")
	HQ has confirmed heavy insurgent activity at the town of Rasam [<marker name='town'>LC062112</marker>] and have strong evidence of an insurgent weapons cache present in the town.
	<br/>
	<br/>
	...
	<br/>
	Location:<br/>
	Rasam [<marker name='town'>LC062112</marker>].<br/>
	<br/>
	MLCOA:<br/>
	...
	NEWTAB("II. Mission:")
	1PLT is to locate and DESTROY the insurgent weapons cache in Rasam [<marker name='town'>LC062112</marker>].
	<br/>
	ENDTAB;
	...
	1PLT is to DESTROY the weapons cache in Rasam [<marker name='town'>LC062112</marker>]<br/>
	<br/>
...
NEWTAB("Being Afghan")
<br/>
It's a good day to be an Afghan civilian in Rasam. 
<br/>
...
NEWTAB("Supply Notes")
<br/>
Due to the daily explosions of Rasam, I always keep a crate of basic medical supplies somewhere in the house. In case of emergency, I also keep my old trusty TT33 in the cabinet.
ENDTAB;
}; //end of civs

...
if (isServer) then { //This scope is only for the server
	...
	[west, "US Forces", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[resistance, "Sand People", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east

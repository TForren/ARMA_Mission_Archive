...
class RscCSSA3InvisibleButton
{
    ...
    soundEnter[] = {"\A3\ui_f\data\sound\RscButton3\soundEnter",0.09,1};
    soundPush[] = {"\A3\ui_f\data\sound\RscButton3\soundPush",0.09,1};
    soundClick[] = {"\A3\ui_f\data\sound\RscButton3\soundClick",0.09,1};
    soundEscape[] = {"\A3\ui_f\data\sound\RscButton3\soundEscape",0.09,1};
    style = 2;
    x = 0;
    y = 0;
    w = 0;
...
class RscCSSA3Button : RscButton3 {
    colorText[] = {1,1,1,1};
    colorDisabled[] = {0.75,0.75,0.75,0};

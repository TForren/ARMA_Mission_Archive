...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		_campBasic     = ["Land_Campfire_F",["Land_WoodPile_F",0,6,0],["Land_TentA_F",6,0,90],["Logic",10,15,0],0];
		_campAmmo      = [];
		...
		_campRandomObj = [[["Land_WoodenLog_F",0,50],["Land_TentA_F",0,40],["Land_WoodenLog_F",0,20],["Land_CerealsBox_F",0,20],["Land_CanisterFuel_F",0,20],["Land_Canteen_F",0,10],["Land_CanisterPlastic_F",0,20],["Land_Shovel_F",0,20],["Land_Axe_F",0,20]], 10, 5, 10, 2];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];
	};
//-------------------------------------------------------------------------------------------------------------------------

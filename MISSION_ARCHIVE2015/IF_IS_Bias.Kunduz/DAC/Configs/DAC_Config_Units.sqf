...
// Independent (A3)
  case 2:
  {
    _Unit_Pool_S = ["LOP_AM_Soldier_TL","LOP_AM_Soldier_SL","LOP_AM_Soldier_Medic","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier_AT","LOP_AM_Soldier","LOP_AM_Soldier_GL","LOP_AM_Soldier_AR","LOP_AM_Soldier_Marksman",
					"LOP_IT_Soldier_TL", "LOP_IT_Soldier_SL", "LOP_IT_Soldier_Marksman", "LOP_IT_Soldier_AR", "LOP_IT_Soldier_GL", "LOP_IT_Driver ", "LOP_IT_Soldier_Medic", "LOP_IT_Soldier_AT"];
    _Unit_Pool_V = ["LOP_CDF_Landrover_M2", "LOP_CDF_Landrover_M2"];
    _Unit_Pool_T = ["LOP_IA_BMP1","rhs_btr70_chdkz", "rhs_bmp1_vdv"];

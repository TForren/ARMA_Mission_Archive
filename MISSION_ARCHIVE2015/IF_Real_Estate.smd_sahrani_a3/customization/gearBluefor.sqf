...
#define B_samag "RH_17Rnd_9x19_g17"
...
case "B_SGT": {
	...
	[B_sgt_backpack] call FNC_AddItemRandom;
	[B_glasses] call FNC_AddItemRandom;
...
//Mortar Assistant
case "B_RAC": {
	["LOP_H_6B27M_RACS"] call FNC_AddItem;
	["LOP_U_RACS_Fatigue_01"] call FNC_AddItem;
	["LOP_V_CarrierLite_WDL"] call FNC_AddItem;

	
	//Uniform
	["rhs_mag_30Rnd_556x45_Mk262_Stanag",2,"uniform"] call FNC_AddItem;

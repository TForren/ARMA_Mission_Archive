...
// Civilians (A3)
  case 3:
  {
    _Unit_Pool_S = 	["RDS_Priest","RDS_Functionary2","RDS_Functionary1","RDS_Citizen4","RDS_Citizen3","RDS_Citizen1","RDS_Citizen2","RDS_Profiteer2","RDS_Profiteer3","RDS_Profiteer1","RDS_Profiteer4","RDS_Villager1","RDS_Villager4","RDS_Villager2","RDS_Villager3","RDS_Woodlander1","RDS_Woodlander2","RDS_Woodlander3","RDS_Woodlander4","RDS_Worker3","RDS_Worker4"];

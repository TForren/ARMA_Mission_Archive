...
// REDFOR (A3)
  case 0:
  {
    ...
    _Unit_Pool_V = ["O_Truck_02_covered_F","O_Truck_02_transport_F","O_MRAP_02_F","O_MRAP_02_gmg_F","O_MRAP_02_hmg_F"];
	_Unit_Pool_T = ["RNR_Pack_rhs_btr60_vdv","RNR_Pack_rhs_btr60_vdv","RNR_Pack_rhs_bmp2_vdv"];

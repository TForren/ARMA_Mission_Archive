...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		...
		_campAmmo      = [];
		_campStatic    = [["RDS_DSHKM_FIA",-7,25,0,"rhs_g_Soldier_SL_F"]];
		_campAddUnit   = [];
		_campUserObj   = [["Land_Sacks_heap_F",17,9,90],["CamoNet_OPFOR_open_F",10,0,0],["Land_PaperBox_open_full_F",17,5,0],["rhs_ural_chdkz",24,8,70]];

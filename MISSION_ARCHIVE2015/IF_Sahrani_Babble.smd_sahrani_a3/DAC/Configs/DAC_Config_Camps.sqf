...
//------------------------------------Radio Com station-----------------------------------------------------------
	case 3:
	{
		_campBasic     = ["Box_East_Wps_F",["Land_WoodPile_F",0,6,0],["Land_TentA_F",6,0,90],["Logic",10,15,0],0];
		_campAmmo      = [];
		_campStatic    = []; //["RDS_DSHKM_FIA", -7, 20, 0, "LOP_ChDKZ_Soldier_AR"]
		_campAddUnit   = ["LOP_ChDKZ_Soldier_AR","LOP_ChDKZ_Soldier_AT"];
		_campUserObj   = [["Land_TentA_F",4, 4, 45],["Land_TentA_F",-6,-2.6,-45],["Land_Sacks_heap_F",3,-6,10]];
		_campRandomObj = [[["Land_WoodenLog_F",0,50],["Land_cargo_addon02_V2_F",0,40],["Land_cargo_addon02_V2_F",0,20],["Land_WoodenBox_F",0,20],
							["Land_CanisterFuel_F",0,20],["Land_Canteen_F",0,10],["Land_CanisterPlastic_F",0,20],["Land_Shovel_F",0,20],
							["Land_Axe_F",0,20],["Campfire_burning_F",0,10],["RHS_NSV_TriPod_VDV",0,5]], 10, 5, 10, 2];
		_campWall      = [];
		_campObjInit   = [[],[],[],[],[],[],[]];
	};
//-------------------------------------------------------------------------------------------------------------------------

...
<br/>
-My truck drivers can be stupid and should be given accurate waypoints to avoid colliding with building corners.
<br/>
-If I find myself in a dire situation, I have stored explosives in the Office cabinet. If the Americans are to reach my HQ, I can at least make sure they get nothing. Especially not my ZBox 350.
<br/>
<br/>
"]];
// ====================================================================================

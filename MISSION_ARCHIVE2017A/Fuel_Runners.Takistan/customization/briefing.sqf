...
NEWTAB("I. Situation:")
<br/>
Iraq Army Forces have setup a fuel depot in North Eastern Takistan allowing large supply chains to operate in the area. The depot is currently lightly defended and can be destroyed if BAF act quickly. If the BAF take too long, they will be overwhelmed by a hopeless amount of QRF forces. RECCE element callsign Foxhound will give early warning about encroaching QRFs.
<br/>
...
~platoon sized security personnel dug-in in and  around the fuel depot.<br/>
Manned bunkers with static weapons around the fuel depot.<br/>
...
ARSENIC PLT is comprised of 3x Rifle Sections, and 1x HQ with Signaller
<br/>
<br/>
...
4x Landrover HMG 4x acog<br/>
2x Landrover GMG 4x acog<br/>
1x Landrover Milan ATGM<br/>
1x Coyote HMG (mortars) <br/>
2x Ammo Crates with explosives.<br/>
ENDTAB;

NEWTAB("II. Mission:")
<font color='#FFA500'>RAID</font> and <font color='#FFA500'>DESTROY</font> the Iraqi fuel trucks and <font color='#FFA500'>EXTRACT</font> to avoid overwelming QRFs.
ENDTAB;

NEWTAB("III. Execution:")

<font color='#FFA500'>a. Concept of the Operation<br/></font>
Destroy the Iraqi Fuel Trucks
<br/>
<br/>
...
<br/>
<br/>BLFUOR VICTORY is achieved when all fuel trucks are destroyed and BLUFOR are extracted.
<br/>
<br/>OPFOR VICTORY is achieved when US sustain heavy casualties.
<br/>
ENDTAB;

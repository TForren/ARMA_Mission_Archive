...
if (isServer) then { //This scope is only for the server
	...
	FW_TimeLimitMessage = "The crash survivors have survived long enough and the US evac is upon the AO. <br/><br/>BLUFOR VICTORY<br/>"; //The message displayed when the time runs out

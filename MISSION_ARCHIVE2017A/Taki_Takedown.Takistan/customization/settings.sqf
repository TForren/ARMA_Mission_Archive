if (isServer) then { //This scope is only for the server
	...
	[west, "BW", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Takistan Army", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east
...
//New end messages
victoryMessage = "Takistan Army forces have taken too many casualties to continue operations. <br/><br/>BLUFOR VICTORY<br/>";
failureMessage = "BW forces have taken too many casualties to continue operations. <br/><br/>OPFOR VICTORY<br/>";

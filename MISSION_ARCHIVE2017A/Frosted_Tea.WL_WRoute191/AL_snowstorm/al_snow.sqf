...
[] spawn {
	...
	[hunt_alias, _tuse] call CBA_fnc_globalSay3d;
...
[] spawn {
	...
	while {al_snowstorm_om} do {	
		...
		[treecrack, _treesu] call CBA_fnc_globalSay3d;
...
[] spawn {
	...
	if (terrain_type_vanilla) then {
		...
		[[_rotocol],"AL_snowstorm\rotocol.sqf"] remoteExec ["BIS_fnc_execVM",0, true];
		
		//[[[_rotocol_1],"AL_snowstorm\rotocol.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
		[[_rotocol_1],"AL_snowstorm\rotocol.sqf"] remoteExec ["BIS_fnc_execVM",0, true];
		sleep 1.5;
...
[[],"AL_snowstorm\alias_snowstorm_effect.sqf"] remoteExec ["BIS_fnc_execVM",0, true];

if (breath_vapors_units) then {
	{
		//[[[_x],"AL_snowstorm\snow_breath.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
		[[_x],"AL_snowstorm\snow_breath.sqf"] remoteExec ["BIS_fnc_execVM",0, true];
		sleep 0.5;

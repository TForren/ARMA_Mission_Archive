...
//Uniform              
#define O_default_uniform_r "LOP_U_AFR_Fatigue_01","LOP_U_AFR_Fatigue_02","LOP_U_AFR_Fatigue_04","LOP_U_AFR_Fatigue_04_slv","LOP_U_UVF_Fatigue_BL_OSW","LOP_U_UVF_Fatigue_COY_OSW","LOP_U_UA_Fatigue_02"

   
//Headgear
#define O_headgear_r "LOP_H_Beanie_dpmw","LOP_H_Beanie_m81","H_Bandanna_gry","H_Bandanna_blu","H_Bandanna_cbr","H_Bandanna_khk","H_Bandanna_sgg","H_Bandanna_sand","H_Bandanna_camo","H_Booniehat_khk","H_Booniehat_tan","rhs_Booniehat_m81","H_Cap_blk","H_Cap_grn","H_Cap_oli"

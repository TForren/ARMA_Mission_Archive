if (isServer) then { //This scope is only for the server
	...
	[west, "Jaegertruppe", "player"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "ChDKZ", "ai"] call FNC_AddTeam; //Adds a ai team called MSV on side east

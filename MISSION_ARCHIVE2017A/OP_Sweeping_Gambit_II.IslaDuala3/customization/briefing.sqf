...
NEWTAB("I. Situation:")
<br/>
ARSENIC 1 has dealt a painful blow to the mainpower of the local weapons smugglers and have cleared the Vestinga island of all enemy combatants.
ARSENIC 2 located and destroyed an enemy RECCE element the the Gerenuk Desert hills and have dug-in as flank security for ARSENIC 1.
ARSENIC 3 located and destroyed drug smugglers in the Obmeya area and have destroyed a large shipment of Khat being sold to fund local insurgencies.
<br/><br/>
Following the elimination of enemy forces on the Vestinga Island, Intel acquired by ARSENIC 1 confirms a weapons cache being stockpiled in the Kwako slums. 
<br/><br/>
3 British Commando Brigade ARSENIC 1 Platoon will locate and destroy the weapons cache. AN-M14 TH3 are supplied in vehicle cargo.
<br/><br/>
<font color='#FFA500'>a. Civilian:<br/></font>
Minor civilian presence in Kwako and activity between Kwako and the nearby civilian airfield.
<br/><br/>
<font color='#FFA500'>b. Area of Interest:<br/></font>
Kwako and the surrounding hills. Afternoon with overcast skies. Light rain expected.
<br/><br/>
<font color='#FFA500'>c. Area of Operations:<br/></font>
Scattered vegetation with large coastal boulders. Rolling defilade. Sparse tree cover allows sight from hilltops.
<br/><br/>
ENDTAB;
...
Exact strength unknown with disorganized enemy logistics of manpower and assets. Expected platoon-sized groups of mercenaries and hired guns in Kwako along with 3-4 technicals.
<br/>
<br/>
<font color='#FFA500'>Location:<br/></font>
Kwako and the surrounding hills. 
<br/>
<br/>
<font color='#FFA500'>MLCOA:<br/></font>
After the previous engagement, enemy forces is likely to expect BAF and thus will most likely stay hidden and in fortified positions and may resort to guerrilla-style fighting.
<br/>
<br/>
<font color='#FFA500'>MDCOA:<br/></font>
As they now know the BAF have begun encroaching, enemy forces may coordinate an ambush and may wipe out large portions of ARSENIC if movement is careless.
<br/>
<br/>
...
Dismantle the weapons/drug empire of Isla Duala.
<br/><br/>
...
2x AN-M14 TH3 per jackal<br/>
<br/>
ENDTAB;

NEWTAB("II. Mission:")
3CB ARSENIC 1 PLT assaults <font color='#FFA500'>OBJ BURNER</font> from <font color='#FFA500'>BP HELCO </font>to allow a breach team to find and destroy the weapons cache in <font color='#FFA500'>OBJ BURNER</font>.
ENDTAB;
...
Destroy the Kwako weapons cache.
<br/>
<br/>
...
<br/>
<br/>BAF victory is achieved when the weapons cache is destroyed.
<br/>

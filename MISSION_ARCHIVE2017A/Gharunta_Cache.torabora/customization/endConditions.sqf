...
if (!alive cache) exitWith { //ends when Opfor deaths above or equal to 75%
	"The Taliban weapons cache has been destroyed and all contained supplies have been denied to the opfor.<br/><br/>US VICTORY<br/>" call FNC_EndMission;
};

...
//Vests
#define B_vest_default "usm_vest_pasgtdcu_lbv_rm"
#define B_vest_light "usm_vest_pasgtdcu_lbe_rm"
#define B_vest_grenadier "usm_vest_pasgtdcu_lbe_gr"
#define B_vest_saw "usm_vest_pasgtdcu_lbe_mg"
#define B_vest_vehiclecrew "usm_vest_pasgtdcu"
#define B_vest_leader "usm_vest_pasgtdcu_lbv_rmp"
...
case "B_PIL": {
	[B_default_uniform] call FNC_AddItem;
	["usm_vest_pasgtdes"] call FNC_AddItem;
	[B_radio_backpack] call FNC_AddItem;
	...
	//Vest
	["rhsusf_mag_7x45acp_MHP",1,"vest"] call FNC_AddItem;
...
case "B_AC": {
	...
	["usm_vest_pasgtdes"] call FNC_AddItem;
	[B_radio_backpack] call FNC_AddItem;
	["rhsusf_hgu56p_mask"] call FNC_AddItem;
	[B_scarf] call FNC_AddItemRandom;

...
case "B_GRE": {
	...
	[B_glsmokered,1,"vest"] call FNC_AddItem;
	[B_glsmokegreen,1,"vest"] call FNC_AddItem;
	[B_glsmokeyellow,1,"vest"] call FNC_AddItem;
...
case "MTR_AGUN": {
	...
	["UK3CB_BAF_1Rnd_60mm_Mo_Shells",5,"backpack"] call FNC_AddItem;

if (isServer) then { //This scope is only for the server
	...
	[independent, "Sunni Mujahideen", "ai"] call FNC_AddTeam; //Adds a player team called USA on side west
	[east, "Gecko 611", "player"] call FNC_AddTeam; //Adds a ai team called MSV on side east
